...
public class AcceptActionUsage extends AbstractNode implements HasSettableParent, IActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue receiverArgument = null;

  protected ReferenceValue payloadParameter = null;

  protected ReferenceValue payloadArgument = null;
  ...
  public AcceptActionUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getAcceptActionUsage();
  }

  public void setReceiverArgument(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("receiverArgument"), 0, receiverArgument);
      }
      receiverArgument = null;
    } else {
      if (partitionObserverCache != null) {
        if (receiverArgument != null) {
          ReferenceValue oldValue = receiverArgument;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("receiverArgument"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("receiverArgument"), 0, value);
        }
      }
      this.receiverArgument = value;
    }
  }

  public ReferenceValue getReceiverArgument() {
    return receiverArgument;
  }

  public void setPayloadParameter(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("payloadParameter"), 0, payloadParameter);
      }
      payloadParameter = null;
    } else {
      if (partitionObserverCache != null) {
        if (payloadParameter != null) {
          ReferenceValue oldValue = payloadParameter;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("payloadParameter"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("payloadParameter"), 0, value);
        }
      }
      this.payloadParameter = value;
    }
  }

  public ReferenceValue getPayloadParameter() {
    return payloadParameter;
  }

  public void setPayloadArgument(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("payloadArgument"), 0, payloadArgument);
      }
      payloadArgument = null;
    } else {
      if (partitionObserverCache != null) {
        if (payloadArgument != null) {
          ReferenceValue oldValue = payloadArgument;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("payloadArgument"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("payloadArgument"), 0, value);
        }
      }
      this.payloadArgument = value;
    }
  }

  public ReferenceValue getPayloadArgument() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-receiverArgument")) {
      return Collections.singletonList(receiverArgument);
    }
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-payloadParameter")) {
      return Collections.singletonList(payloadParameter);
    }
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-payloadArgument")) {
      return Collections.singletonList(payloadArgument);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-receiverArgument")) {
      ...
      setReceiverArgument(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-payloadParameter")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setPayloadParameter(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-payloadArgument")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setPayloadArgument(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-receiverArgument")) {
      if (index >= 1 || receiverArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      receiverArgument = receiverArgument.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-payloadParameter")) {
      if (index >= 1 || payloadParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      payloadParameter = payloadParameter.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-payloadArgument")) {
      if (index >= 1 || payloadArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      payloadArgument = payloadArgument.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-receiverArgument")) {
      if (index >= 1 || receiverArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      receiverArgument = receiverArgument.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-payloadParameter")) {
      if (index >= 1 || payloadParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      payloadParameter = payloadParameter.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AcceptActionUsage-payloadArgument")) {
      if (index >= 1 || payloadArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      payloadArgument = payloadArgument.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
      if (index >= actionDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
