...
public class ActorMembership extends ParameterMembership {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedActorParameter = null;

  public ActorMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getActorMembership();
  }

  public void setOwnedActorParameter(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedActorParameter"), 0, ownedActorParameter);
      }
      ownedActorParameter = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedActorParameter != null) {
          ReferenceValue oldValue = ownedActorParameter;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedActorParameter"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedActorParameter"), 0, value);
        }
      }
      this.ownedActorParameter = value;
    }
  }

  public ReferenceValue getOwnedActorParameter() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ActorMembership-ownedActorParameter")) {
      return Collections.singletonList(ownedActorParameter);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ActorMembership-ownedActorParameter")) {
      ...
      setOwnedActorParameter(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-ActorMembership-ownedActorParameter")) {
      if (index >= 1 || ownedActorParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedActorParameter = ownedActorParameter.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ParameterMembership-ownedMemberParameter")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ActorMembership-ownedActorParameter")) {
      if (index >= 1 || ownedActorParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedActorParameter = ownedActorParameter.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ParameterMembership-ownedMemberParameter")) {
      if (index >= 1 || ownedMemberParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
