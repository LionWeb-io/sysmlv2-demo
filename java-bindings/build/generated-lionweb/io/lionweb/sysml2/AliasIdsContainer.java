...
public class AliasIdsContainer extends AbstractNode implements HasSettableParent {
  @NotNull
  private String id;
  ...
  public AliasIdsContainer(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getAliasIdsContainer();
  }
  ...
  public void setAliasIds(String value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("aliasIds"), getAliasIds(), value);
        }
    this.aliasIds = value;
  }
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-AliasIdsContainer-aliasIds")) {
      return aliasIds;
    }
