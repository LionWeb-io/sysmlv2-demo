...
public class AnalysisCaseDefinition extends CaseDefinition {
  @NotNull
  private String id;
  ...
  public AnalysisCaseDefinition(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getAnalysisCaseDefinition();
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-AnalysisCaseDefinition-resultExpression")) {
