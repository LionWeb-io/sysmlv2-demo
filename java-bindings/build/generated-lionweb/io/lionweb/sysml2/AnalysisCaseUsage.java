...
public class AnalysisCaseUsage extends CaseUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue analysisCaseDefinition = null;

  protected ReferenceValue resultExpression = null;

  public AnalysisCaseUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getAnalysisCaseUsage();
  }

  public void setAnalysisCaseDefinition(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("analysisCaseDefinition"), 0, analysisCaseDefinition);
      }
      analysisCaseDefinition = null;
    } else {
      if (partitionObserverCache != null) {
        if (analysisCaseDefinition != null) {
          ReferenceValue oldValue = analysisCaseDefinition;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("analysisCaseDefinition"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("analysisCaseDefinition"), 0, value);
        }
      }
      this.analysisCaseDefinition = value;
    }
  }

  public ReferenceValue getAnalysisCaseDefinition() {
    return analysisCaseDefinition;
  }

  public void setResultExpression(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("resultExpression"), 0, resultExpression);
      }
      resultExpression = null;
    } else {
      if (partitionObserverCache != null) {
        if (resultExpression != null) {
          ReferenceValue oldValue = resultExpression;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("resultExpression"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("resultExpression"), 0, value);
        }
      }
  ...
  public ReferenceValue getResultExpression() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-AnalysisCaseUsage-analysisCaseDefinition")) {
      return Collections.singletonList(analysisCaseDefinition);
    }
    if (Objects.equals(reference.getKey(), "sysml-AnalysisCaseUsage-resultExpression")) {
      return Collections.singletonList(resultExpression);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-AnalysisCaseUsage-analysisCaseDefinition")) {
      ...
      setAnalysisCaseDefinition(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AnalysisCaseUsage-resultExpression")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setResultExpression(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-AnalysisCaseUsage-analysisCaseDefinition")) {
      if (index >= 1 || analysisCaseDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      analysisCaseDefinition = analysisCaseDefinition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AnalysisCaseUsage-resultExpression")) {
      if (index >= 1 || resultExpression == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      resultExpression = resultExpression.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-objectiveRequirement")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-AnalysisCaseUsage-analysisCaseDefinition")) {
      if (index >= 1 || analysisCaseDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      analysisCaseDefinition = analysisCaseDefinition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AnalysisCaseUsage-resultExpression")) {
      if (index >= 1 || resultExpression == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      resultExpression = resultExpression.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-objectiveRequirement")) {
      if (index >= 1 || objectiveRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
