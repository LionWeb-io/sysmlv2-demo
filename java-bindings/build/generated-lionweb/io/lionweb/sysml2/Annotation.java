...
public class Annotation extends AbstractNode implements HasSettableParent, IRelationship {
  @NotNull
  private String id;
  ...
  protected ReferenceValue annotatingElement = null;

  protected ReferenceValue annotatedElement = null;

  protected ReferenceValue owningAnnotatedElement = null;

  protected ReferenceValue ownedAnnotatingElement = null;

  protected ReferenceValue owningAnnotatingElement = null;
  ...
  public Annotation(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getAnnotation();
  }

  public void setAnnotatingElement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("annotatingElement"), 0, annotatingElement);
      }
      annotatingElement = null;
    } else {
      if (partitionObserverCache != null) {
        if (annotatingElement != null) {
          ReferenceValue oldValue = annotatingElement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("annotatingElement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("annotatingElement"), 0, value);
        }
      }
      this.annotatingElement = value;
    }
  }

  public ReferenceValue getAnnotatingElement() {
    return annotatingElement;
  }

  public void setAnnotatedElement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("annotatedElement"), 0, annotatedElement);
      }
      annotatedElement = null;
    } else {
      if (partitionObserverCache != null) {
        if (annotatedElement != null) {
          ReferenceValue oldValue = annotatedElement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("annotatedElement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("annotatedElement"), 0, value);
        }
      }
  ...
  public ReferenceValue getAnnotatedElement() {
    return annotatedElement;
  }

  public void setOwningAnnotatedElement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("owningAnnotatedElement"), 0, owningAnnotatedElement);
      }
      owningAnnotatedElement = null;
    } else {
      if (partitionObserverCache != null) {
        if (owningAnnotatedElement != null) {
          ReferenceValue oldValue = owningAnnotatedElement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("owningAnnotatedElement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("owningAnnotatedElement"), 0, value);
        }
      }
      this.owningAnnotatedElement = value;
    }
  }

  public ReferenceValue getOwningAnnotatedElement() {
    return owningAnnotatedElement;
  }

  public void setOwnedAnnotatingElement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedAnnotatingElement"), 0, ownedAnnotatingElement);
      }
      ownedAnnotatingElement = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedAnnotatingElement != null) {
          ReferenceValue oldValue = ownedAnnotatingElement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedAnnotatingElement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedAnnotatingElement"), 0, value);
        }
      }
      this.ownedAnnotatingElement = value;
    }
  }

  public ReferenceValue getOwnedAnnotatingElement() {
    return ownedAnnotatingElement;
  }

  public void setOwningAnnotatingElement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("owningAnnotatingElement"), 0, owningAnnotatingElement);
      }
      owningAnnotatingElement = null;
    } else {
      if (partitionObserverCache != null) {
        if (owningAnnotatingElement != null) {
          ReferenceValue oldValue = owningAnnotatingElement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("owningAnnotatingElement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("owningAnnotatingElement"), 0, value);
        }
      }
      this.owningAnnotatingElement = value;
    }
  }

  public ReferenceValue getOwningAnnotatingElement() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-Annotation-annotatingElement")) {
      return Collections.singletonList(annotatingElement);
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-annotatedElement")) {
      return Collections.singletonList(annotatedElement);
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-owningAnnotatedElement")) {
      return Collections.singletonList(owningAnnotatedElement);
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-ownedAnnotatingElement")) {
      return Collections.singletonList(ownedAnnotatingElement);
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-owningAnnotatingElement")) {
      return Collections.singletonList(owningAnnotatingElement);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-Annotation-annotatingElement")) {
      ...
      setAnnotatingElement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-annotatedElement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setAnnotatedElement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-owningAnnotatedElement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setOwningAnnotatedElement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-ownedAnnotatingElement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setOwnedAnnotatingElement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-owningAnnotatingElement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setOwningAnnotatingElement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-Annotation-annotatingElement")) {
      if (index >= 1 || annotatingElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      annotatingElement = annotatingElement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-annotatedElement")) {
      if (index >= 1 || annotatedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      annotatedElement = annotatedElement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-owningAnnotatedElement")) {
      if (index >= 1 || owningAnnotatedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      owningAnnotatedElement = owningAnnotatedElement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-ownedAnnotatingElement")) {
      if (index >= 1 || ownedAnnotatingElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedAnnotatingElement = ownedAnnotatingElement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-owningAnnotatingElement")) {
      if (index >= 1 || owningAnnotatingElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      owningAnnotatingElement = owningAnnotatingElement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-Annotation-annotatingElement")) {
      if (index >= 1 || annotatingElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      annotatingElement = annotatingElement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-annotatedElement")) {
      if (index >= 1 || annotatedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      annotatedElement = annotatedElement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-owningAnnotatedElement")) {
      if (index >= 1 || owningAnnotatedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      owningAnnotatedElement = owningAnnotatedElement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-ownedAnnotatingElement")) {
      if (index >= 1 || ownedAnnotatingElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedAnnotatingElement = ownedAnnotatingElement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Annotation-owningAnnotatingElement")) {
      if (index >= 1 || owningAnnotatingElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      owningAnnotatingElement = owningAnnotatingElement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
      if (index >= 1 || owningRelatedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
