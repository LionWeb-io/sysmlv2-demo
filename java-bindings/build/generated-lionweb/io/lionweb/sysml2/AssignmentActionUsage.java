...
public class AssignmentActionUsage extends AbstractNode implements HasSettableParent, IActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue targetArgument = null;

  protected ReferenceValue valueExpression = null;

  protected ReferenceValue referent = null;
  ...
  public AssignmentActionUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getAssignmentActionUsage();
  }

  public void setTargetArgument(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("targetArgument"), 0, targetArgument);
      }
      targetArgument = null;
    } else {
      if (partitionObserverCache != null) {
        if (targetArgument != null) {
          ReferenceValue oldValue = targetArgument;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("targetArgument"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("targetArgument"), 0, value);
        }
      }
      this.targetArgument = value;
    }
  }

  public ReferenceValue getTargetArgument() {
    return targetArgument;
  }

  public void setValueExpression(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("valueExpression"), 0, valueExpression);
      }
      valueExpression = null;
    } else {
      if (partitionObserverCache != null) {
        if (valueExpression != null) {
          ReferenceValue oldValue = valueExpression;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("valueExpression"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("valueExpression"), 0, value);
        }
      }
  ...
  public ReferenceValue getValueExpression() {
    return valueExpression;
  }

  public void setReferent(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("referent"), 0, referent);
      }
      referent = null;
    } else {
      if (partitionObserverCache != null) {
        if (referent != null) {
          ReferenceValue oldValue = referent;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("referent"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("referent"), 0, value);
        }
      }
      this.referent = value;
    }
  ...
  public ReferenceValue getReferent() {
    return referent;
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-targetArgument")) {
      return Collections.singletonList(targetArgument);
    }
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-valueExpression")) {
      return Collections.singletonList(valueExpression);
    }
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-referent")) {
      return Collections.singletonList(referent);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-targetArgument")) {
      ...
      setTargetArgument(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-valueExpression")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setValueExpression(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-referent")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setReferent(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-targetArgument")) {
      if (index >= 1 || targetArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      targetArgument = targetArgument.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-valueExpression")) {
      if (index >= 1 || valueExpression == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      valueExpression = valueExpression.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-referent")) {
      if (index >= 1 || referent == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      referent = referent.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-targetArgument")) {
      if (index >= 1 || targetArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      targetArgument = targetArgument.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-valueExpression")) {
      if (index >= 1 || valueExpression == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      valueExpression = valueExpression.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AssignmentActionUsage-referent")) {
      if (index >= 1 || referent == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      referent = referent.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
      if (index >= actionDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
