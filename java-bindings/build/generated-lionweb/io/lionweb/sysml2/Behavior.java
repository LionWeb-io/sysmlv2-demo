...
public class Behavior extends AbstractNode implements HasSettableParent, IBehavior {
  @NotNull
  private String id;
  ...
  public Behavior(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getBehavior();
  }
