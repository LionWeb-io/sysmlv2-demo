...
public class BindingConnector extends AbstractNode implements HasSettableParent, IBindingConnector {
  @NotNull
  private String id;
  ...
  public BindingConnector(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getBindingConnector();
  }
