...
public class BooleanExpression extends AbstractNode implements HasSettableParent, IBooleanExpression {
  @NotNull
  private String id;
  ...
  public BooleanExpression(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getBooleanExpression();
  }
