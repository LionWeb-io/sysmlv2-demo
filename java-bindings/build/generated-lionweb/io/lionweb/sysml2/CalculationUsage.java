...
public class CalculationUsage extends AbstractNode implements HasSettableParent, IActionUsage, IExpression {
  @NotNull
  private String id;
  ...
  protected ReferenceValue calculationDefinition = null;
  ...
  public CalculationUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getCalculationUsage();
  }

  public void setCalculationDefinition(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("calculationDefinition"), 0, calculationDefinition);
      }
      calculationDefinition = null;
    } else {
      if (partitionObserverCache != null) {
        if (calculationDefinition != null) {
          ReferenceValue oldValue = calculationDefinition;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("calculationDefinition"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("calculationDefinition"), 0, value);
        }
      }
  ...
  public ReferenceValue getCalculationDefinition() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-CalculationUsage-calculationDefinition")) {
      return Collections.singletonList(calculationDefinition);
    }
