...
public class CaseUsage extends CalculationUsage {
  @NotNull
  private String id;
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getCaseUsage();
  }
  ...
  public void setCaseDefinition(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("caseDefinition"), 0, caseDefinition);
      }
      caseDefinition = null;
    } else {
      if (partitionObserverCache != null) {
        if (caseDefinition != null) {
          ReferenceValue oldValue = caseDefinition;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("caseDefinition"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("caseDefinition"), 0, value);
        }
      }
  ...
  public ReferenceValue getCaseDefinition() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-caseDefinition")) {
      return Collections.singletonList(caseDefinition);
    }
