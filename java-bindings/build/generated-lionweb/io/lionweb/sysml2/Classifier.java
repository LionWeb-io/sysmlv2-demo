...
public class Classifier extends AbstractNode implements HasSettableParent, IClassifier {
  @NotNull
  private String id;
  ...
  public Classifier(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getClassifier();
  }
