...
public class CollectExpression extends OperatorExpression {
  @NotNull
  private String id;
  ...
  public CollectExpression(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getCollectExpression();
  }
