...
public class Comment extends AbstractNode implements HasSettableParent, IAnnotatingElement {
  @NotNull
  private String id;
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getComment();
  }
  ...
  public void setLocale(String value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("locale"), getLocale(), value);
        }
    this.locale = value;
  }
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-Comment-locale")) {
      return locale;
    }
    if (Objects.equals(property.getKey(), "sysml-Comment-body")) {
      return body;
    }
