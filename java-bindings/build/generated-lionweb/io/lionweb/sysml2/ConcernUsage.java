...
public class ConcernUsage extends RequirementUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue concernDefinition = null;

  public ConcernUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getConcernUsage();
  }

  public void setConcernDefinition(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("concernDefinition"), 0, concernDefinition);
      }
      concernDefinition = null;
    } else {
      if (partitionObserverCache != null) {
        if (concernDefinition != null) {
          ReferenceValue oldValue = concernDefinition;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("concernDefinition"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("concernDefinition"), 0, value);
        }
      }
      this.concernDefinition = value;
    }
  }

  public ReferenceValue getConcernDefinition() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ConcernUsage-concernDefinition")) {
      return Collections.singletonList(concernDefinition);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ConcernUsage-concernDefinition")) {
      ...
      setConcernDefinition(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-ConcernUsage-concernDefinition")) {
      if (index >= 1 || concernDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      concernDefinition = concernDefinition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementUsage-requirementDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ConcernUsage-concernDefinition")) {
      if (index >= 1 || concernDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      concernDefinition = concernDefinition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementUsage-requirementDefinition")) {
      if (index >= 1 || requirementDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
