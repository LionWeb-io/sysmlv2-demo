...
public class ConjugatedPortDefinition extends PortDefinition {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedPortConjugator = null;

  protected ReferenceValue originalPortDefinition = null;

  public ConjugatedPortDefinition(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getConjugatedPortDefinition();
  }

  public void setOwnedPortConjugator(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedPortConjugator"), 0, ownedPortConjugator);
      }
      ownedPortConjugator = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedPortConjugator != null) {
          ReferenceValue oldValue = ownedPortConjugator;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedPortConjugator"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedPortConjugator"), 0, value);
        }
      }
      this.ownedPortConjugator = value;
    }
  }

  public ReferenceValue getOwnedPortConjugator() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ConjugatedPortDefinition-ownedPortConjugator")) {
      return Collections.singletonList(ownedPortConjugator);
    }
    if (Objects.equals(reference.getKey(), "sysml-ConjugatedPortDefinition-originalPortDefinition")) {
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ConjugatedPortDefinition-ownedPortConjugator")) {
      ...
      setOwnedPortConjugator(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ConjugatedPortDefinition-originalPortDefinition")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
    ...
    if (Objects.equals(reference.getKey(), "sysml-PortDefinition-conjugatedPortDefinition")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-ConjugatedPortDefinition-ownedPortConjugator")) {
      if (index >= 1 || ownedPortConjugator == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedPortConjugator = ownedPortConjugator.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ConjugatedPortDefinition-originalPortDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ConjugatedPortDefinition-ownedPortConjugator")) {
      if (index >= 1 || ownedPortConjugator == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedPortConjugator = ownedPortConjugator.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ConjugatedPortDefinition-originalPortDefinition")) {
      if (index >= 1 || originalPortDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
