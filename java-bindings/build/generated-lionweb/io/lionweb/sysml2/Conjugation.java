...
public class Conjugation extends AbstractNode implements HasSettableParent, IRelationship {
  @NotNull
  private String id;
  ...
  protected ReferenceValue originalType = null;

  protected ReferenceValue conjugatedType = null;
  ...
  public Conjugation(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getConjugation();
  }

  public void setOriginalType(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("originalType"), 0, originalType);
      }
      originalType = null;
    } else {
      if (partitionObserverCache != null) {
        if (originalType != null) {
          ReferenceValue oldValue = originalType;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("originalType"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("originalType"), 0, value);
        }
      }
  ...
  public ReferenceValue getOriginalType() {
    return originalType;
  }

  public void setConjugatedType(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("conjugatedType"), 0, conjugatedType);
      }
      conjugatedType = null;
    } else {
      if (partitionObserverCache != null) {
        if (conjugatedType != null) {
          ReferenceValue oldValue = conjugatedType;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("conjugatedType"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("conjugatedType"), 0, value);
        }
      }
      this.conjugatedType = value;
    }
  }

  public ReferenceValue getConjugatedType() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-Conjugation-originalType")) {
      return Collections.singletonList(originalType);
    }
    if (Objects.equals(reference.getKey(), "sysml-Conjugation-conjugatedType")) {
      return Collections.singletonList(conjugatedType);
    }
