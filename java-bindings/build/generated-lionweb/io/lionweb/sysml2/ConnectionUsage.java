...
public class ConnectionUsage extends ConnectorAsUsage implements IPartUsage {
  @NotNull
  private String id;
  ...
  protected List<ReferenceValue> connectionDefinition = new ArrayList<>();
  ...
  public ConnectionUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getConnectionUsage();
  }

  public int addToConnectionDefinition(ReferenceValue referenceValue, int index) {
    if (index > connectionDefinition.size()) {
      throw new IllegalArgumentException("Index must be less than or equal to size");
    }
    if (partitionObserverCache != null) {
      partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("connectionDefinition"), index, referenceValue);
    }
    connectionDefinition.add(index, referenceValue);
    return connectionDefinition.size() - 1;
  }

  public List<ReferenceValue> getConnectionDefinition() {
    return connectionDefinition;
  }

  public int addToConnectionDefinition(IAssociationStructure referred) {
    return addToConnectionDefinition(new ReferenceValue(referred, null), connectionDefinition.size());
  }

  public int addToConnectionDefinition(IAssociationStructure referred, int index) {
    return addToConnectionDefinition(new ReferenceValue(referred, null), index);
  }

  public void clearConnectionDefinition() {
    while (!connectionDefinition.isEmpty()) {
            removeFromConnectionDefinition(0);
        };
  }

  public void removeFromConnectionDefinition(@NotNull ReferenceValue child) {
    int index = connectionDefinition.indexOf(child);
             if (index == -1) {
                 throw new IllegalArgumentException("Child not found: " + child);
             }
             removeFromConnectionDefinition(index);;
  }

  public void removeFromConnectionDefinition(int index) {
    if (connectionDefinition.size() > index) {

            ReferenceValue removed = connectionDefinition.remove(index);
            if (partitionObserverCache != null) {
              partitionObserverCache.referenceValueRemoved(this, getClassifier().requireReferenceByName("connectionDefinition"), index, removed);
            }
          } else {
            throw new IllegalArgumentException(
                "Invalid index "
                    ...
                    + connectionDefinition.size());
          }
  }

  public void setConnectionDefinition(@NotNull List<? extends ReferenceValue> newValue) {
    clearConnectionDefinition();
          for (ReferenceValue referenceValue : newValue) {
              addToConnectionDefinition(referenceValue, connectionDefinition.size());
          }
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ConnectionUsage-connectionDefinition")) {
      return connectionDefinition;
    }
  ...
  public int addReferenceValue(Reference reference, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-ConnectionUsage-connectionDefinition")) {
      return addToConnectionDefinition(referredNode, connectionDefinition.size());
    }
    if (Objects.equals(reference.getKey(), "sysml-IPartUsage-partDefinition")) {
  ...
  public int addReferenceValue(Reference reference, int index, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-ConnectionUsage-connectionDefinition")) {
      return addToConnectionDefinition(referredNode, index);
    }
    if (Objects.equals(reference.getKey(), "sysml-IPartUsage-partDefinition")) {
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ConnectionUsage-connectionDefinition")) {
      setConnectionDefinition(values);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IPartUsage-partDefinition")) {
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-ConnectionUsage-connectionDefinition")) {
      if (index >= connectionDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = connectionDefinition.get(index);
      connectionDefinition.set(index, original.withReferred(referredNode));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IPartUsage-partDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ConnectionUsage-connectionDefinition")) {
      if (index >= connectionDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = connectionDefinition.get(index);
      connectionDefinition.set(index, original.withResolveInfo(resolveInfo));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IPartUsage-partDefinition")) {
      if (index >= partDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
