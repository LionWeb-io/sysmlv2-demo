...
public class Connector extends AbstractNode implements HasSettableParent, IConnector {
  @NotNull
  private String id;
  ...
  public Connector(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getConnector();
  }
