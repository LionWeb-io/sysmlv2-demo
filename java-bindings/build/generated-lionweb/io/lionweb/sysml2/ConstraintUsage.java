...
public class ConstraintUsage extends AbstractNode implements HasSettableParent, IConstraintUsage {
  @NotNull
  private String id;
  ...
  public ConstraintUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getConstraintUsage();
  }
