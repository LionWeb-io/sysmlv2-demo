...
public class CrossSubsetting extends Subsetting {
  @NotNull
  private String id;
  ...
  protected ReferenceValue crossedFeature = null;

  protected ReferenceValue crossingFeature = null;

  public CrossSubsetting(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getCrossSubsetting();
  }

  public void setCrossedFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("crossedFeature"), 0, crossedFeature);
      }
      crossedFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (crossedFeature != null) {
          ReferenceValue oldValue = crossedFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("crossedFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("crossedFeature"), 0, value);
        }
      }
      this.crossedFeature = value;
    }
  }

  public ReferenceValue getCrossedFeature() {
    return crossedFeature;
  }

  public void setCrossingFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("crossingFeature"), 0, crossingFeature);
      }
      crossingFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (crossingFeature != null) {
          ReferenceValue oldValue = crossingFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("crossingFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("crossingFeature"), 0, value);
        }
      }
      this.crossingFeature = value;
    }
  }

  public ReferenceValue getCrossingFeature() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-CrossSubsetting-crossedFeature")) {
      return Collections.singletonList(crossedFeature);
    }
    if (Objects.equals(reference.getKey(), "sysml-CrossSubsetting-crossingFeature")) {
      return Collections.singletonList(crossingFeature);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-CrossSubsetting-crossedFeature")) {
      ...
      setCrossedFeature(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CrossSubsetting-crossingFeature")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setCrossingFeature(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-CrossSubsetting-crossedFeature")) {
      if (index >= 1 || crossedFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      crossedFeature = crossedFeature.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CrossSubsetting-crossingFeature")) {
      if (index >= 1 || crossingFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      crossingFeature = crossingFeature.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Subsetting-subsettedFeature")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-CrossSubsetting-crossedFeature")) {
      if (index >= 1 || crossedFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      crossedFeature = crossedFeature.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CrossSubsetting-crossingFeature")) {
      if (index >= 1 || crossingFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      crossingFeature = crossingFeature.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Subsetting-subsettedFeature")) {
      if (index >= 1 || subsettedFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
