...
public class DataType extends AbstractNode implements HasSettableParent, IDataType {
  @NotNull
  private String id;
  ...
  public DataType(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getDataType();
  }
