...
public class Differencing extends AbstractNode implements HasSettableParent, IRelationship {
  @NotNull
  private String id;
  ...
  protected ReferenceValue differencingType = null;

  protected ReferenceValue typeDifferenced = null;
  ...
  public Differencing(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getDifferencing();
  }

  public void setDifferencingType(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("differencingType"), 0, differencingType);
      }
      differencingType = null;
    } else {
      if (partitionObserverCache != null) {
        if (differencingType != null) {
          ReferenceValue oldValue = differencingType;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("differencingType"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("differencingType"), 0, value);
        }
      }
      this.differencingType = value;
    }
  }

  public ReferenceValue getDifferencingType() {
    return differencingType;
  }

  public void setTypeDifferenced(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("typeDifferenced"), 0, typeDifferenced);
      }
      typeDifferenced = null;
    } else {
      if (partitionObserverCache != null) {
        if (typeDifferenced != null) {
          ReferenceValue oldValue = typeDifferenced;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("typeDifferenced"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("typeDifferenced"), 0, value);
        }
      }
      this.typeDifferenced = value;
    }
  }

  public ReferenceValue getTypeDifferenced() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-Differencing-differencingType")) {
      return Collections.singletonList(differencingType);
    }
    if (Objects.equals(reference.getKey(), "sysml-Differencing-typeDifferenced")) {
      return Collections.singletonList(typeDifferenced);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-Differencing-differencingType")) {
      ...
      setDifferencingType(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Differencing-typeDifferenced")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setTypeDifferenced(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-Differencing-differencingType")) {
      if (index >= 1 || differencingType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      differencingType = differencingType.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Differencing-typeDifferenced")) {
      if (index >= 1 || typeDifferenced == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      typeDifferenced = typeDifferenced.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-Differencing-differencingType")) {
      if (index >= 1 || differencingType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      differencingType = differencingType.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Differencing-typeDifferenced")) {
      if (index >= 1 || typeDifferenced == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      typeDifferenced = typeDifferenced.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
      if (index >= 1 || owningRelatedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
