...
public class Disjoining extends AbstractNode implements HasSettableParent, IRelationship {
  @NotNull
  private String id;
  ...
  protected ReferenceValue typeDisjoined = null;

  protected ReferenceValue disjoiningType = null;
  ...
  public Disjoining(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getDisjoining();
  }

  public void setTypeDisjoined(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("typeDisjoined"), 0, typeDisjoined);
      }
      typeDisjoined = null;
    } else {
      if (partitionObserverCache != null) {
        if (typeDisjoined != null) {
          ReferenceValue oldValue = typeDisjoined;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("typeDisjoined"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("typeDisjoined"), 0, value);
        }
      }
      this.typeDisjoined = value;
    }
  }

  public ReferenceValue getTypeDisjoined() {
    return typeDisjoined;
  }

  public void setDisjoiningType(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("disjoiningType"), 0, disjoiningType);
      }
      disjoiningType = null;
    } else {
      if (partitionObserverCache != null) {
        if (disjoiningType != null) {
          ReferenceValue oldValue = disjoiningType;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("disjoiningType"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("disjoiningType"), 0, value);
        }
      }
      this.disjoiningType = value;
    }
  }

  public ReferenceValue getDisjoiningType() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-typeDisjoined")) {
      return Collections.singletonList(typeDisjoined);
    }
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-disjoiningType")) {
      return Collections.singletonList(disjoiningType);
    }
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-owningType")) {
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-typeDisjoined")) {
      ...
      setTypeDisjoined(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-disjoiningType")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setDisjoiningType(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-owningType")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-typeDisjoined")) {
      if (index >= 1 || typeDisjoined == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      typeDisjoined = typeDisjoined.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-disjoiningType")) {
      if (index >= 1 || disjoiningType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      disjoiningType = disjoiningType.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-owningType")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-typeDisjoined")) {
      if (index >= 1 || typeDisjoined == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      typeDisjoined = typeDisjoined.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-disjoiningType")) {
      if (index >= 1 || disjoiningType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      disjoiningType = disjoiningType.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Disjoining-owningType")) {
      if (index >= 1 || owningType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
