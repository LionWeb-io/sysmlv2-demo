...
public class ElementFilterMembership extends OwningMembership {
  @NotNull
  private String id;
  ...
  protected ReferenceValue condition = null;

  public ElementFilterMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getElementFilterMembership();
  }

  public void setCondition(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("condition"), 0, condition);
      }
      condition = null;
    } else {
      if (partitionObserverCache != null) {
        if (condition != null) {
          ReferenceValue oldValue = condition;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("condition"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("condition"), 0, value);
        }
      }
  ...
  public ReferenceValue getCondition() {
    return condition;
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ElementFilterMembership-condition")) {
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ElementFilterMembership-condition")) {
      ...
      setCondition(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-ElementFilterMembership-condition")) {
      if (index >= 1 || condition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      condition = condition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-OwningMembership-ownedMemberElement")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ElementFilterMembership-condition")) {
      if (index >= 1 || condition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      condition = condition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-OwningMembership-ownedMemberElement")) {
      if (index >= 1 || ownedMemberElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
