...
public class EnumerationUsage extends AttributeUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue enumerationDefinition = null;

  public EnumerationUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getEnumerationUsage();
  }

  public void setEnumerationDefinition(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("enumerationDefinition"), 0, enumerationDefinition);
      }
      enumerationDefinition = null;
    } else {
      if (partitionObserverCache != null) {
        if (enumerationDefinition != null) {
          ReferenceValue oldValue = enumerationDefinition;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("enumerationDefinition"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("enumerationDefinition"), 0, value);
        }
      }
      this.enumerationDefinition = value;
    }
  }

  public ReferenceValue getEnumerationDefinition() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-EnumerationUsage-enumerationDefinition")) {
      return Collections.singletonList(enumerationDefinition);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-EnumerationUsage-enumerationDefinition")) {
      ...
      setEnumerationDefinition(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-EnumerationUsage-enumerationDefinition")) {
      if (index >= 1 || enumerationDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      enumerationDefinition = enumerationDefinition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AttributeUsage-attributeDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-EnumerationUsage-enumerationDefinition")) {
      if (index >= 1 || enumerationDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      enumerationDefinition = enumerationDefinition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-AttributeUsage-attributeDefinition")) {
      if (index >= attributeDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
