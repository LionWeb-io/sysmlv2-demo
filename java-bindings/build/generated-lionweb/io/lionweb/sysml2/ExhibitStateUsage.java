...
public class ExhibitStateUsage extends StateUsage implements IPerformActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue exhibitedState = null;
  ...
  public ExhibitStateUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getExhibitStateUsage();
  }

  public void setExhibitedState(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("exhibitedState"), 0, exhibitedState);
      }
      exhibitedState = null;
    } else {
      if (partitionObserverCache != null) {
        if (exhibitedState != null) {
          ReferenceValue oldValue = exhibitedState;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("exhibitedState"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("exhibitedState"), 0, value);
        }
      }
      this.exhibitedState = value;
    }
  }

  public ReferenceValue getExhibitedState() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ExhibitStateUsage-exhibitedState")) {
      return Collections.singletonList(exhibitedState);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ExhibitStateUsage-exhibitedState")) {
      ...
      setExhibitedState(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-ExhibitStateUsage-exhibitedState")) {
      if (index >= 1 || exhibitedState == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      exhibitedState = exhibitedState.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-stateDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ExhibitStateUsage-exhibitedState")) {
      if (index >= 1 || exhibitedState == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      exhibitedState = exhibitedState.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-stateDefinition")) {
      if (index >= stateDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
