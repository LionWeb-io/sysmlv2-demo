...
public class Expression extends AbstractNode implements HasSettableParent, IExpression {
  @NotNull
  private String id;
  ...
  public Expression(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getExpression();
  }
