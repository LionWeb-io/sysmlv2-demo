...
public class FeatureChaining extends AbstractNode implements HasSettableParent, IRelationship {
  @NotNull
  private String id;
  ...
  protected ReferenceValue chainingFeature = null;

  protected ReferenceValue featureChained = null;
  ...
  public FeatureChaining(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getFeatureChaining();
  }

  public void setChainingFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("chainingFeature"), 0, chainingFeature);
      }
      chainingFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (chainingFeature != null) {
          ReferenceValue oldValue = chainingFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("chainingFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("chainingFeature"), 0, value);
        }
      }
      this.chainingFeature = value;
    }
  }

  public ReferenceValue getChainingFeature() {
    return chainingFeature;
  }

  public void setFeatureChained(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("featureChained"), 0, featureChained);
      }
      featureChained = null;
    } else {
      if (partitionObserverCache != null) {
        if (featureChained != null) {
          ReferenceValue oldValue = featureChained;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("featureChained"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("featureChained"), 0, value);
        }
      }
      this.featureChained = value;
    }
  }

  public ReferenceValue getFeatureChained() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-FeatureChaining-chainingFeature")) {
      return Collections.singletonList(chainingFeature);
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureChaining-featureChained")) {
      return Collections.singletonList(featureChained);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-FeatureChaining-chainingFeature")) {
      ...
      setChainingFeature(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureChaining-featureChained")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setFeatureChained(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-FeatureChaining-chainingFeature")) {
      if (index >= 1 || chainingFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      chainingFeature = chainingFeature.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureChaining-featureChained")) {
      if (index >= 1 || featureChained == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      featureChained = featureChained.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-FeatureChaining-chainingFeature")) {
      if (index >= 1 || chainingFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      chainingFeature = chainingFeature.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureChaining-featureChained")) {
      if (index >= 1 || featureChained == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      featureChained = featureChained.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
      if (index >= 1 || owningRelatedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
