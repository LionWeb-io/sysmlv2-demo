...
public class FeatureInverting extends AbstractNode implements HasSettableParent, IRelationship {
  @NotNull
  private String id;
  ...
  protected ReferenceValue featureInverted = null;

  protected ReferenceValue invertingFeature = null;

  protected ReferenceValue owningFeature = null;
  ...
  public FeatureInverting(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getFeatureInverting();
  }

  public void setFeatureInverted(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("featureInverted"), 0, featureInverted);
      }
      featureInverted = null;
    } else {
      if (partitionObserverCache != null) {
        if (featureInverted != null) {
          ReferenceValue oldValue = featureInverted;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("featureInverted"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("featureInverted"), 0, value);
        }
      }
      this.featureInverted = value;
    }
  }

  public ReferenceValue getFeatureInverted() {
    return featureInverted;
  }

  public void setInvertingFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("invertingFeature"), 0, invertingFeature);
      }
      invertingFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (invertingFeature != null) {
          ReferenceValue oldValue = invertingFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("invertingFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("invertingFeature"), 0, value);
        }
      }
      this.invertingFeature = value;
    }
  }

  public ReferenceValue getInvertingFeature() {
    return invertingFeature;
  }

  public void setOwningFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("owningFeature"), 0, owningFeature);
      }
      owningFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (owningFeature != null) {
          ReferenceValue oldValue = owningFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("owningFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("owningFeature"), 0, value);
        }
      }
      this.owningFeature = value;
    }
  }

  public ReferenceValue getOwningFeature() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-featureInverted")) {
      return Collections.singletonList(featureInverted);
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-invertingFeature")) {
      return Collections.singletonList(invertingFeature);
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-owningFeature")) {
      return Collections.singletonList(owningFeature);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-featureInverted")) {
      ...
      setFeatureInverted(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-invertingFeature")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setInvertingFeature(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-owningFeature")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-featureInverted")) {
      if (index >= 1 || featureInverted == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      featureInverted = featureInverted.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-invertingFeature")) {
      if (index >= 1 || invertingFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      invertingFeature = invertingFeature.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-owningFeature")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-featureInverted")) {
      if (index >= 1 || featureInverted == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      featureInverted = featureInverted.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-invertingFeature")) {
      if (index >= 1 || invertingFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      invertingFeature = invertingFeature.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureInverting-owningFeature")) {
      if (index >= 1 || owningFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
