...
public class FeatureMembership extends OwningMembership implements IFeaturing {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedMemberFeature = null;
  ...
  public FeatureMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getFeatureMembership();
  }

  public void setOwnedMemberFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedMemberFeature"), 0, ownedMemberFeature);
      }
      ownedMemberFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedMemberFeature != null) {
          ReferenceValue oldValue = ownedMemberFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedMemberFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedMemberFeature"), 0, value);
        }
      }
      this.ownedMemberFeature = value;
    }
  }

  public ReferenceValue getOwnedMemberFeature() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
      return Collections.singletonList(ownedMemberFeature);
    }
