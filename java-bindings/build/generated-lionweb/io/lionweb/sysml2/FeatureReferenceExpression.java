...
public class FeatureReferenceExpression extends AbstractNode implements HasSettableParent, IExpression {
  @NotNull
  private String id;
  ...
  public FeatureReferenceExpression(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getFeatureReferenceExpression();
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-FeatureReferenceExpression-referent")) {
