...
public class FeatureTyping extends Specialization {
  @NotNull
  private String id;
  ...
  protected ReferenceValue typedFeature = null;

  protected ReferenceValue type = null;

  protected ReferenceValue owningFeature = null;

  public FeatureTyping(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getFeatureTyping();
  }

  public void setTypedFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("typedFeature"), 0, typedFeature);
      }
      typedFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (typedFeature != null) {
          ReferenceValue oldValue = typedFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("typedFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("typedFeature"), 0, value);
        }
      }
      this.typedFeature = value;
    }
  }

  public ReferenceValue getTypedFeature() {
    return typedFeature;
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-FeatureTyping-typedFeature")) {
      return Collections.singletonList(typedFeature);
    }
