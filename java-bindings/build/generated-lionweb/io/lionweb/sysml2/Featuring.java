...
public class Featuring extends AbstractNode implements HasSettableParent, IFeaturing {
  @NotNull
  private String id;
  ...
  public Featuring(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getFeaturing();
  }
