...
public class ForLoopActionUsage extends LoopActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue seqArgument = null;

  protected ReferenceValue loopVariable = null;

  public ForLoopActionUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getForLoopActionUsage();
  }

  public void setSeqArgument(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("seqArgument"), 0, seqArgument);
      }
      seqArgument = null;
    } else {
      if (partitionObserverCache != null) {
        if (seqArgument != null) {
          ReferenceValue oldValue = seqArgument;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("seqArgument"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("seqArgument"), 0, value);
        }
      }
      this.seqArgument = value;
    }
  }

  public ReferenceValue getSeqArgument() {
    return seqArgument;
  }

  public void setLoopVariable(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("loopVariable"), 0, loopVariable);
      }
      loopVariable = null;
    } else {
      if (partitionObserverCache != null) {
        if (loopVariable != null) {
          ReferenceValue oldValue = loopVariable;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("loopVariable"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("loopVariable"), 0, value);
        }
      }
  ...
  public ReferenceValue getLoopVariable() {
    return loopVariable;
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ForLoopActionUsage-seqArgument")) {
      return Collections.singletonList(seqArgument);
    }
    if (Objects.equals(reference.getKey(), "sysml-ForLoopActionUsage-loopVariable")) {
      return Collections.singletonList(loopVariable);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ForLoopActionUsage-seqArgument")) {
      ...
      setSeqArgument(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ForLoopActionUsage-loopVariable")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setLoopVariable(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-ForLoopActionUsage-seqArgument")) {
      if (index >= 1 || seqArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      seqArgument = seqArgument.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ForLoopActionUsage-loopVariable")) {
      if (index >= 1 || loopVariable == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      loopVariable = loopVariable.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-LoopActionUsage-bodyAction")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ForLoopActionUsage-seqArgument")) {
      if (index >= 1 || seqArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      seqArgument = seqArgument.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ForLoopActionUsage-loopVariable")) {
      if (index >= 1 || loopVariable == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      loopVariable = loopVariable.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-LoopActionUsage-bodyAction")) {
      if (index >= 1 || bodyAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
