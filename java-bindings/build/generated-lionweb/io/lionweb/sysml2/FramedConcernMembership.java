...
public class FramedConcernMembership extends RequirementConstraintMembership {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedConcern = null;

  protected ReferenceValue referencedConcern = null;

  public FramedConcernMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getFramedConcernMembership();
  }

  public void setOwnedConcern(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedConcern"), 0, ownedConcern);
      }
      ownedConcern = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedConcern != null) {
          ReferenceValue oldValue = ownedConcern;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedConcern"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedConcern"), 0, value);
        }
      }
      this.ownedConcern = value;
    }
  }

  public ReferenceValue getOwnedConcern() {
    return ownedConcern;
  }

  public void setReferencedConcern(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("referencedConcern"), 0, referencedConcern);
      }
      referencedConcern = null;
    } else {
      if (partitionObserverCache != null) {
        if (referencedConcern != null) {
          ReferenceValue oldValue = referencedConcern;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("referencedConcern"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("referencedConcern"), 0, value);
        }
      }
      this.referencedConcern = value;
    }
  }

  public ReferenceValue getReferencedConcern() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-FramedConcernMembership-ownedConcern")) {
      return Collections.singletonList(ownedConcern);
    }
    if (Objects.equals(reference.getKey(), "sysml-FramedConcernMembership-referencedConcern")) {
      return Collections.singletonList(referencedConcern);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-FramedConcernMembership-ownedConcern")) {
      ...
      setOwnedConcern(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FramedConcernMembership-referencedConcern")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setReferencedConcern(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-FramedConcernMembership-ownedConcern")) {
      if (index >= 1 || ownedConcern == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedConcern = ownedConcern.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FramedConcernMembership-referencedConcern")) {
      if (index >= 1 || referencedConcern == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      referencedConcern = referencedConcern.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementConstraintMembership-ownedConstraint")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-FramedConcernMembership-ownedConcern")) {
      if (index >= 1 || ownedConcern == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedConcern = ownedConcern.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FramedConcernMembership-referencedConcern")) {
      if (index >= 1 || referencedConcern == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      referencedConcern = referencedConcern.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementConstraintMembership-ownedConstraint")) {
      if (index >= 1 || ownedConstraint == null) throw new IllegalArgumentException("index should be less than the size of the list");;
