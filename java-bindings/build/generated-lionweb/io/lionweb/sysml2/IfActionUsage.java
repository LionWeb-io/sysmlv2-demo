...
public class IfActionUsage extends AbstractNode implements HasSettableParent, IActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue elseAction = null;

  protected ReferenceValue thenAction = null;

  protected ReferenceValue ifArgument = null;
  ...
  public IfActionUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getIfActionUsage();
  }

  public void setElseAction(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("elseAction"), 0, elseAction);
      }
      elseAction = null;
    } else {
      if (partitionObserverCache != null) {
        if (elseAction != null) {
          ReferenceValue oldValue = elseAction;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("elseAction"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("elseAction"), 0, value);
        }
      }
      this.elseAction = value;
    }
  }

  public ReferenceValue getElseAction() {
    return elseAction;
  }

  public void setThenAction(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("thenAction"), 0, thenAction);
      }
      thenAction = null;
    } else {
      if (partitionObserverCache != null) {
        if (thenAction != null) {
          ReferenceValue oldValue = thenAction;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("thenAction"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("thenAction"), 0, value);
        }
      }
      this.thenAction = value;
    }
  }

  public ReferenceValue getThenAction() {
    return thenAction;
  }

  public void setIfArgument(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ifArgument"), 0, ifArgument);
      }
      ifArgument = null;
    } else {
      if (partitionObserverCache != null) {
        if (ifArgument != null) {
          ReferenceValue oldValue = ifArgument;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ifArgument"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ifArgument"), 0, value);
        }
      }
      this.ifArgument = value;
    }
  }

  public ReferenceValue getIfArgument() {
    return ifArgument;
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-elseAction")) {
      return Collections.singletonList(elseAction);
    }
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-thenAction")) {
      return Collections.singletonList(thenAction);
    }
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-ifArgument")) {
      return Collections.singletonList(ifArgument);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-elseAction")) {
      ...
      setElseAction(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-thenAction")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setThenAction(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-ifArgument")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setIfArgument(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-elseAction")) {
      if (index >= 1 || elseAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      elseAction = elseAction.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-thenAction")) {
      if (index >= 1 || thenAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      thenAction = thenAction.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-ifArgument")) {
      if (index >= 1 || ifArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ifArgument = ifArgument.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-elseAction")) {
      if (index >= 1 || elseAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      elseAction = elseAction.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-thenAction")) {
      if (index >= 1 || thenAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      thenAction = thenAction.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IfActionUsage-ifArgument")) {
      if (index >= 1 || ifArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ifArgument = ifArgument.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
      if (index >= actionDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
