...
public class IncludeUseCaseUsage extends UseCaseUsage implements IPerformActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue useCaseIncluded = null;

  protected ReferenceValue performedAction = null;
  ...
  protected ReferenceValue eventOccurrence = null;

  public IncludeUseCaseUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getIncludeUseCaseUsage();
  }

  public void setUseCaseIncluded(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("useCaseIncluded"), 0, useCaseIncluded);
      }
      useCaseIncluded = null;
    } else {
      if (partitionObserverCache != null) {
        if (useCaseIncluded != null) {
          ReferenceValue oldValue = useCaseIncluded;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("useCaseIncluded"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("useCaseIncluded"), 0, value);
        }
      }
      this.useCaseIncluded = value;
    }
  }

  public ReferenceValue getUseCaseIncluded() {
    return useCaseIncluded;
  }

  public void setPerformedAction(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("performedAction"), 0, performedAction);
      }
      performedAction = null;
    } else {
      if (partitionObserverCache != null) {
        if (performedAction != null) {
          ReferenceValue oldValue = performedAction;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("performedAction"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("performedAction"), 0, value);
        }
      }
  ...
  public ReferenceValue getPerformedAction() {
  ...
  public void setEventOccurrence(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("eventOccurrence"), 0, eventOccurrence);
      }
      eventOccurrence = null;
    } else {
      if (partitionObserverCache != null) {
        if (eventOccurrence != null) {
          ReferenceValue oldValue = eventOccurrence;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("eventOccurrence"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("eventOccurrence"), 0, value);
        }
      }
      this.eventOccurrence = value;
    }
  }

  public ReferenceValue getEventOccurrence() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-IncludeUseCaseUsage-useCaseIncluded")) {
      return Collections.singletonList(useCaseIncluded);
    }
    if (Objects.equals(reference.getKey(), "sysml-IPerformActionUsage-performedAction")) {
      return Collections.singletonList(performedAction);
    }
    ...
    if (Objects.equals(reference.getKey(), "sysml-IEventOccurrenceUsage-eventOccurrence")) {
      return Collections.singletonList(eventOccurrence);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-IncludeUseCaseUsage-useCaseIncluded")) {
      ...
      setUseCaseIncluded(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IPerformActionUsage-performedAction")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setPerformedAction(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-UseCaseUsage-useCaseDefinition")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setUseCaseDefinition(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-UseCaseUsage-includedUseCase")) {
      setIncludedUseCase(values);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-objectiveRequirement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setObjectiveRequirement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-caseDefinition")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setCaseDefinition(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-subjectParameter")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setSubjectParameter(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-actorParameter")) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-IEventOccurrenceUsage-eventOccurrence")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setEventOccurrence(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IOccurrenceUsage-occurrenceDefinition")) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-CalculationUsage-calculationDefinition")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setCalculationDefinition(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IStep-behavior")) {
      setBehavior(values);
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-IncludeUseCaseUsage-useCaseIncluded")) {
      if (index >= 1 || useCaseIncluded == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      useCaseIncluded = useCaseIncluded.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IPerformActionUsage-performedAction")) {
      if (index >= 1 || performedAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      performedAction = performedAction.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-UseCaseUsage-useCaseDefinition")) {
      if (index >= 1 || useCaseDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      useCaseDefinition = useCaseDefinition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-UseCaseUsage-includedUseCase")) {
      if (index >= includedUseCase.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = includedUseCase.get(index);
      includedUseCase.set(index, original.withReferred(referredNode));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-objectiveRequirement")) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-caseDefinition")) {
      if (index >= 1 || caseDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      caseDefinition = caseDefinition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-subjectParameter")) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-IEventOccurrenceUsage-eventOccurrence")) {
      if (index >= 1 || eventOccurrence == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      eventOccurrence = eventOccurrence.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IOccurrenceUsage-occurrenceDefinition")) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-CalculationUsage-calculationDefinition")) {
      if (index >= 1 || calculationDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      calculationDefinition = calculationDefinition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IStep-behavior")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-IncludeUseCaseUsage-useCaseIncluded")) {
      if (index >= 1 || useCaseIncluded == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      useCaseIncluded = useCaseIncluded.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IPerformActionUsage-performedAction")) {
      if (index >= 1 || performedAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      performedAction = performedAction.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-UseCaseUsage-useCaseDefinition")) {
      if (index >= 1 || useCaseDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      useCaseDefinition = useCaseDefinition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-UseCaseUsage-includedUseCase")) {
      if (index >= includedUseCase.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = includedUseCase.get(index);
      includedUseCase.set(index, original.withResolveInfo(resolveInfo));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-objectiveRequirement")) {
      if (index >= 1 || objectiveRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
    ...
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-caseDefinition")) {
      if (index >= 1 || caseDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      caseDefinition = caseDefinition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-subjectParameter")) {
      if (index >= 1 || subjectParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
    ...
    if (Objects.equals(reference.getKey(), "sysml-IEventOccurrenceUsage-eventOccurrence")) {
      if (index >= 1 || eventOccurrence == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      eventOccurrence = eventOccurrence.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IOccurrenceUsage-occurrenceDefinition")) {
      if (index >= occurrenceDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
    ...
    if (Objects.equals(reference.getKey(), "sysml-CalculationUsage-calculationDefinition")) {
      if (index >= 1 || calculationDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      calculationDefinition = calculationDefinition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IStep-behavior")) {
      if (index >= behavior.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
