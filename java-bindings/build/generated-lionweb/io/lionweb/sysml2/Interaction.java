...
public class Interaction extends AbstractNode implements HasSettableParent, IInteraction {
  @NotNull
  private String id;
  ...
  public Interaction(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getInteraction();
  }
