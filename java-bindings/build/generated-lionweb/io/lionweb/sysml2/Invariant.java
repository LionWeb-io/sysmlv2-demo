...
public class Invariant extends AbstractNode implements HasSettableParent, IInvariant {
  @NotNull
  private String id;
  ...
  public Invariant(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getInvariant();
  }
