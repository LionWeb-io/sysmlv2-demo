...
public class ItemFeature extends AbstractNode implements HasSettableParent, IFeature {
  @NotNull
  private String id;
  ...
  public ItemFeature(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getItemFeature();
  }
