...
public class ItemFlow extends AbstractNode implements HasSettableParent, IItemFlow {
  @NotNull
  private String id;
  ...
  public ItemFlow(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getItemFlow();
  }
