...
public class ItemFlowEnd extends AbstractNode implements HasSettableParent, IFeature {
  @NotNull
  private String id;
  ...
  public ItemFlowEnd(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getItemFlowEnd();
  }
