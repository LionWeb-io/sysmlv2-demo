...
public class ItemUsage extends AbstractNode implements HasSettableParent, IItemUsage {
  @NotNull
  private String id;
  ...
  public ItemUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getItemUsage();
  }
