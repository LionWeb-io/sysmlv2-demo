...
public class LifeClass extends AbstractNode implements HasSettableParent, IClass {
  @NotNull
  private String id;
  ...
  public LifeClass(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getLifeClass();
  }
