...
public class LiteralRational extends LiteralExpression {
  @NotNull
  private String id;
  ...
  public LiteralRational(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getLiteralRational();
  }
  ...
  public void setValue(Double value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("value"), getValue(), value);
        }
    this.value = value;
  }
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-LiteralRational-value")) {
      return value;
    }
