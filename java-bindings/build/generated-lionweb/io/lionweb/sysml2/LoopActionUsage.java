...
public abstract class LoopActionUsage extends AbstractNode implements HasSettableParent, IActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue bodyAction = null;
  ...
  public LoopActionUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getLoopActionUsage();
  }

  public void setBodyAction(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("bodyAction"), 0, bodyAction);
      }
      bodyAction = null;
    } else {
      if (partitionObserverCache != null) {
        if (bodyAction != null) {
          ReferenceValue oldValue = bodyAction;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("bodyAction"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("bodyAction"), 0, value);
        }
      }
      this.bodyAction = value;
    }
  }

  public ReferenceValue getBodyAction() {
    return bodyAction;
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-LoopActionUsage-bodyAction")) {
      return Collections.singletonList(bodyAction);
    }
