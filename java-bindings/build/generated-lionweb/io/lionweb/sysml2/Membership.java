...
public class Membership extends AbstractNode implements HasSettableParent, IRelationship {
  @NotNull
  private String id;
  ...
  protected String memberElementId;

  protected ReferenceValue membershipOwningNamespace = null;

  protected String memberShortName;

  protected ReferenceValue memberElement = null;
  ...
  public Membership(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getMembership();
  }
  ...
  public void setMemberElementId(String value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("memberElementId"), getMemberElementId(), value);
        }
    this.memberElementId = value;
  }

  public void setMembershipOwningNamespace(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("membershipOwningNamespace"), 0, membershipOwningNamespace);
      }
      membershipOwningNamespace = null;
    } else {
      if (partitionObserverCache != null) {
        if (membershipOwningNamespace != null) {
          ReferenceValue oldValue = membershipOwningNamespace;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("membershipOwningNamespace"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("membershipOwningNamespace"), 0, value);
        }
      }
      this.membershipOwningNamespace = value;
    }
  }

  public ReferenceValue getMembershipOwningNamespace() {
  ...
  public void setMemberShortName(String value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("memberShortName"), getMemberShortName(), value);
        }
    this.memberShortName = value;
  }

  public void setMemberElement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("memberElement"), 0, memberElement);
      }
      memberElement = null;
    } else {
      if (partitionObserverCache != null) {
        if (memberElement != null) {
          ReferenceValue oldValue = memberElement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("memberElement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("memberElement"), 0, value);
        }
      }
      this.memberElement = value;
    }
  }

  public ReferenceValue getMemberElement() {
  ...
  public void setMemberName(String value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("memberName"), getMemberName(), value);
        }
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-Membership-memberElementId")) {
      return memberElementId;
    }
    if (Objects.equals(property.getKey(), "sysml-Membership-memberShortName")) {
      return memberShortName;
    }
    if (Objects.equals(property.getKey(), "sysml-Membership-memberName")) {
      return memberName;
    }
    if (Objects.equals(property.getKey(), "sysml-Membership-visibility")) {
      return visibility;
    }
  ...
  public void setPropertyValue(Property property, Object value) {
    ...
    if (Objects.equals(property.getKey(), "sysml-Membership-memberElementId")) {
      setMemberElementId((String) value);
      return;
    }
    if (Objects.equals(property.getKey(), "sysml-Membership-memberShortName")) {
      setMemberShortName((String) value);
      return;
    }
    if (Objects.equals(property.getKey(), "sysml-Membership-memberName")) {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-Membership-membershipOwningNamespace")) {
      return Collections.singletonList(membershipOwningNamespace);
    }
    if (Objects.equals(reference.getKey(), "sysml-Membership-memberElement")) {
      return Collections.singletonList(memberElement);
    }
