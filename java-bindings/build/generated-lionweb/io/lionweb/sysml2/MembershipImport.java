...
public class MembershipImport extends AbstractNode implements HasSettableParent, IImport {
  @NotNull
  private String id;
  ...
  protected ReferenceValue importedMembership = null;
  ...
  protected ReferenceValue importedElement = null;

  protected ReferenceValue importOwningNamespace = null;
  ...
  public MembershipImport(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getMembershipImport();
  }

  public void setImportedMembership(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("importedMembership"), 0, importedMembership);
      }
      importedMembership = null;
    } else {
      if (partitionObserverCache != null) {
        if (importedMembership != null) {
          ReferenceValue oldValue = importedMembership;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("importedMembership"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("importedMembership"), 0, value);
        }
      }
      this.importedMembership = value;
    }
  }

  public ReferenceValue getImportedMembership() {
  ...
  public void setVisibility(VisibilityKind value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("visibility"), getVisibility(), value);
        }
  ...
  public void setIsRecursive(Boolean value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("isRecursive"), getIsRecursive(), value);
        }
  ...
  public void setIsImportAll(Boolean value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("isImportAll"), getIsImportAll(), value);
        }
    this.isImportAll = value;
  }

  public void setImportedElement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("importedElement"), 0, importedElement);
      }
      importedElement = null;
    } else {
      if (partitionObserverCache != null) {
        if (importedElement != null) {
          ReferenceValue oldValue = importedElement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("importedElement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("importedElement"), 0, value);
        }
      }
  ...
  public ReferenceValue getImportedElement() {
    return importedElement;
  }

  public void setImportOwningNamespace(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("importOwningNamespace"), 0, importOwningNamespace);
      }
      importOwningNamespace = null;
    } else {
      if (partitionObserverCache != null) {
        if (importOwningNamespace != null) {
          ReferenceValue oldValue = importOwningNamespace;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("importOwningNamespace"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("importOwningNamespace"), 0, value);
        }
      }
      this.importOwningNamespace = value;
    }
  }

  public ReferenceValue getImportOwningNamespace() {
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-IImport-visibility")) {
      return visibility;
    }
    if (Objects.equals(property.getKey(), "sysml-IImport-isRecursive")) {
      return isRecursive;
    }
    if (Objects.equals(property.getKey(), "sysml-IImport-isImportAll")) {
      return isImportAll;
    }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-MembershipImport-importedMembership")) {
      return Collections.singletonList(importedMembership);
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importedElement")) {
      return Collections.singletonList(importedElement);
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importOwningNamespace")) {
      return Collections.singletonList(importOwningNamespace);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-MembershipImport-importedMembership")) {
      ...
      setImportedMembership(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importedElement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setImportedElement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importOwningNamespace")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setImportOwningNamespace(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-MembershipImport-importedMembership")) {
      if (index >= 1 || importedMembership == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      importedMembership = importedMembership.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importedElement")) {
      if (index >= 1 || importedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      importedElement = importedElement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importOwningNamespace")) {
      if (index >= 1 || importOwningNamespace == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      importOwningNamespace = importOwningNamespace.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-MembershipImport-importedMembership")) {
      if (index >= 1 || importedMembership == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      importedMembership = importedMembership.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importedElement")) {
      if (index >= 1 || importedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      importedElement = importedElement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importOwningNamespace")) {
      if (index >= 1 || importOwningNamespace == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      importOwningNamespace = importOwningNamespace.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IRelationship-owningRelatedElement")) {
      if (index >= 1 || owningRelatedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
