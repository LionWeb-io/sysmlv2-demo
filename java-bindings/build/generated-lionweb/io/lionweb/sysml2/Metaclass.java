...
public class Metaclass extends AbstractNode implements HasSettableParent, IMetaclass {
  @NotNull
  private String id;
  ...
  public Metaclass(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getMetaclass();
  }
