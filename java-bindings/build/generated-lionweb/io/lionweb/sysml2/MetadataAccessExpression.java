...
public class MetadataAccessExpression extends AbstractNode implements HasSettableParent, IExpression {
  @NotNull
  private String id;
  ...
  protected ReferenceValue referencedElement = null;
  ...
  public MetadataAccessExpression(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getMetadataAccessExpression();
  }

  public void setReferencedElement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("referencedElement"), 0, referencedElement);
      }
      referencedElement = null;
    } else {
      if (partitionObserverCache != null) {
        if (referencedElement != null) {
          ReferenceValue oldValue = referencedElement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("referencedElement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("referencedElement"), 0, value);
        }
      }
  ...
  public ReferenceValue getReferencedElement() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-MetadataAccessExpression-referencedElement")) {
      return Collections.singletonList(referencedElement);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-MetadataAccessExpression-referencedElement")) {
      ...
      setReferencedElement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IExpression-function")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-MetadataAccessExpression-referencedElement")) {
      if (index >= 1 || referencedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      referencedElement = referencedElement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IExpression-function")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-MetadataAccessExpression-referencedElement")) {
      if (index >= 1 || referencedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      referencedElement = referencedElement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IExpression-function")) {
      if (index >= 1 || function == null) throw new IllegalArgumentException("index should be less than the size of the list");;
