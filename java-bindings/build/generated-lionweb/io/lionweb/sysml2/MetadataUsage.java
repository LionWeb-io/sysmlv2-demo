...
public class MetadataUsage extends MetadataFeature implements IItemUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue metadataDefinition = null;
  ...
  public MetadataUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getMetadataUsage();
  }

  public void setMetadataDefinition(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("metadataDefinition"), 0, metadataDefinition);
      }
      metadataDefinition = null;
    } else {
      if (partitionObserverCache != null) {
        if (metadataDefinition != null) {
          ReferenceValue oldValue = metadataDefinition;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("metadataDefinition"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("metadataDefinition"), 0, value);
        }
      }
      this.metadataDefinition = value;
    }
  }

  public ReferenceValue getMetadataDefinition() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-MetadataUsage-metadataDefinition")) {
      return Collections.singletonList(metadataDefinition);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-MetadataUsage-metadataDefinition")) {
      ...
      setMetadataDefinition(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-MetadataUsage-metadataDefinition")) {
      if (index >= 1 || metadataDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      metadataDefinition = metadataDefinition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-MetadataFeature-metaclass")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-MetadataUsage-metadataDefinition")) {
      if (index >= 1 || metadataDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      metadataDefinition = metadataDefinition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-MetadataFeature-metaclass")) {
      if (index >= 1 || metaclass == null) throw new IllegalArgumentException("index should be less than the size of the list");;
