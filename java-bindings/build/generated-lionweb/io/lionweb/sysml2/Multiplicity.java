...
public class Multiplicity extends AbstractNode implements HasSettableParent, IFeature {
  @NotNull
  private String id;
  ...
  public Multiplicity(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getMultiplicity();
  }
