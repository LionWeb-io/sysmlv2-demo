...
public class NamespaceExpose extends NamespaceImport implements IExpose {
  @NotNull
  private String id;
  ...
  public NamespaceExpose(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getNamespaceExpose();
  }
