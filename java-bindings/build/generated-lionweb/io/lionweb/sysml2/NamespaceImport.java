...
public class NamespaceImport extends AbstractNode implements HasSettableParent, IImport {
  @NotNull
  private String id;
  ...
  protected ReferenceValue importedNamespace = null;
  ...
  public NamespaceImport(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getNamespaceImport();
  }

  public void setImportedNamespace(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("importedNamespace"), 0, importedNamespace);
      }
      importedNamespace = null;
    } else {
      if (partitionObserverCache != null) {
        if (importedNamespace != null) {
          ReferenceValue oldValue = importedNamespace;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("importedNamespace"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("importedNamespace"), 0, value);
        }
      }
      this.importedNamespace = value;
    }
  }

  public ReferenceValue getImportedNamespace() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-NamespaceImport-importedNamespace")) {
      return Collections.singletonList(importedNamespace);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-NamespaceImport-importedNamespace")) {
      ...
      setImportedNamespace(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importedElement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-NamespaceImport-importedNamespace")) {
      if (index >= 1 || importedNamespace == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      importedNamespace = importedNamespace.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importedElement")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-NamespaceImport-importedNamespace")) {
      if (index >= 1 || importedNamespace == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      importedNamespace = importedNamespace.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IImport-importedElement")) {
      if (index >= 1 || importedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
