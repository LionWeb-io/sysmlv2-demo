...
public class NullExpression extends AbstractNode implements HasSettableParent, IExpression {
  @NotNull
  private String id;
  ...
  public NullExpression(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getNullExpression();
  }
