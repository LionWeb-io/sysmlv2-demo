...
public class ObjectiveMembership extends FeatureMembership {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedObjectiveRequirement = null;

  public ObjectiveMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getObjectiveMembership();
  }

  public void setOwnedObjectiveRequirement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedObjectiveRequirement"), 0, ownedObjectiveRequirement);
      }
      ownedObjectiveRequirement = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedObjectiveRequirement != null) {
          ReferenceValue oldValue = ownedObjectiveRequirement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedObjectiveRequirement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedObjectiveRequirement"), 0, value);
        }
      }
      this.ownedObjectiveRequirement = value;
    }
  }

  public ReferenceValue getOwnedObjectiveRequirement() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ObjectiveMembership-ownedObjectiveRequirement")) {
      return Collections.singletonList(ownedObjectiveRequirement);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ObjectiveMembership-ownedObjectiveRequirement")) {
      ...
      setOwnedObjectiveRequirement(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-ObjectiveMembership-ownedObjectiveRequirement")) {
      if (index >= 1 || ownedObjectiveRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedObjectiveRequirement = ownedObjectiveRequirement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ObjectiveMembership-ownedObjectiveRequirement")) {
      if (index >= 1 || ownedObjectiveRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedObjectiveRequirement = ownedObjectiveRequirement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
      if (index >= 1 || ownedMemberFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
