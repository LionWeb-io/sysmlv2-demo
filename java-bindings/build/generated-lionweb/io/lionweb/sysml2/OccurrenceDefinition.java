...
public class OccurrenceDefinition extends Definition implements IClass {
  @NotNull
  private String id;
  ...
  protected ReferenceValue lifeClass = null;
  ...
  public OccurrenceDefinition(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getOccurrenceDefinition();
  }

  public void setLifeClass(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("lifeClass"), 0, lifeClass);
      }
      lifeClass = null;
    } else {
      if (partitionObserverCache != null) {
        if (lifeClass != null) {
          ReferenceValue oldValue = lifeClass;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("lifeClass"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("lifeClass"), 0, value);
        }
      }
      this.lifeClass = value;
    }
  }

  public ReferenceValue getLifeClass() {
    return lifeClass;
  }
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-OccurrenceDefinition-isIndividual")) {
      return isIndividual;
    }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-OccurrenceDefinition-lifeClass")) {
      return Collections.singletonList(lifeClass);
    }
