...
public class OccurrenceUsage extends AbstractNode implements HasSettableParent, IOccurrenceUsage {
  @NotNull
  private String id;
  ...
  public OccurrenceUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getOccurrenceUsage();
  }
