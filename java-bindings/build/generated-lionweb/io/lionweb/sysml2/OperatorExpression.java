...
public class OperatorExpression extends InvocationExpression {
  @NotNull
  private String id;
  ...
  public OperatorExpression(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getOperatorExpression();
  }
  ...
  public void setOperator(String value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("operator"), getOperator(), value);
        }
    this.operator = value;
  }
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-OperatorExpression-operator")) {
      return operator;
    }
