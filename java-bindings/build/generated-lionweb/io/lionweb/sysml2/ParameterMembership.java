...
public class ParameterMembership extends FeatureMembership {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedMemberParameter = null;

  public ParameterMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getParameterMembership();
  }

  public void setOwnedMemberParameter(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedMemberParameter"), 0, ownedMemberParameter);
      }
      ownedMemberParameter = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedMemberParameter != null) {
          ReferenceValue oldValue = ownedMemberParameter;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedMemberParameter"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedMemberParameter"), 0, value);
        }
      }
      this.ownedMemberParameter = value;
    }
  }

  public ReferenceValue getOwnedMemberParameter() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ParameterMembership-ownedMemberParameter")) {
      return Collections.singletonList(ownedMemberParameter);
    }
