...
public class PartUsage extends AbstractNode implements HasSettableParent, IPartUsage {
  @NotNull
  private String id;
  ...
  public PartUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getPartUsage();
  }
