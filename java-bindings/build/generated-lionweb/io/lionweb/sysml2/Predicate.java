...
public class Predicate extends AbstractNode implements HasSettableParent, IPredicate {
  @NotNull
  private String id;
  ...
  public Predicate(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getPredicate();
  }
