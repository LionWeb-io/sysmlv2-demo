...
public class Redefinition extends Subsetting {
  @NotNull
  private String id;
  ...
  protected ReferenceValue redefiningFeature = null;

  protected ReferenceValue redefinedFeature = null;

  public Redefinition(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getRedefinition();
  }

  public void setRedefiningFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("redefiningFeature"), 0, redefiningFeature);
      }
      redefiningFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (redefiningFeature != null) {
          ReferenceValue oldValue = redefiningFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("redefiningFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("redefiningFeature"), 0, value);
        }
      }
  ...
  public ReferenceValue getRedefiningFeature() {
    return redefiningFeature;
  }

  public void setRedefinedFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("redefinedFeature"), 0, redefinedFeature);
      }
      redefinedFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (redefinedFeature != null) {
          ReferenceValue oldValue = redefinedFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("redefinedFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("redefinedFeature"), 0, value);
        }
      }
  ...
  public ReferenceValue getRedefinedFeature() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-Redefinition-redefiningFeature")) {
      return Collections.singletonList(redefiningFeature);
    }
    if (Objects.equals(reference.getKey(), "sysml-Redefinition-redefinedFeature")) {
      return Collections.singletonList(redefinedFeature);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-Redefinition-redefiningFeature")) {
      ...
      setRedefiningFeature(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Redefinition-redefinedFeature")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setRedefinedFeature(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-Redefinition-redefiningFeature")) {
      if (index >= 1 || redefiningFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      redefiningFeature = redefiningFeature.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Redefinition-redefinedFeature")) {
      if (index >= 1 || redefinedFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      redefinedFeature = redefinedFeature.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Subsetting-subsettedFeature")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-Redefinition-redefiningFeature")) {
      if (index >= 1 || redefiningFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      redefiningFeature = redefiningFeature.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Redefinition-redefinedFeature")) {
      if (index >= 1 || redefinedFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      redefinedFeature = redefinedFeature.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Subsetting-subsettedFeature")) {
      if (index >= 1 || subsettedFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
