...
public class ReferenceUsage extends AbstractNode implements HasSettableParent, IUsage {
  @NotNull
  private String id;
  ...
  public ReferenceUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getReferenceUsage();
  }
