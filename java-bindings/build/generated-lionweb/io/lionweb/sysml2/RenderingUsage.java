...
public class RenderingUsage extends AbstractNode implements HasSettableParent, IPartUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue renderingDefinition = null;
  ...
  public RenderingUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getRenderingUsage();
  }

  public void setRenderingDefinition(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("renderingDefinition"), 0, renderingDefinition);
      }
      renderingDefinition = null;
    } else {
      if (partitionObserverCache != null) {
        if (renderingDefinition != null) {
          ReferenceValue oldValue = renderingDefinition;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("renderingDefinition"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("renderingDefinition"), 0, value);
        }
      }
      this.renderingDefinition = value;
    }
  }

  public ReferenceValue getRenderingDefinition() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-RenderingUsage-renderingDefinition")) {
      return Collections.singletonList(renderingDefinition);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-RenderingUsage-renderingDefinition")) {
      ...
      setRenderingDefinition(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IPartUsage-partDefinition")) {
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-RenderingUsage-renderingDefinition")) {
      if (index >= 1 || renderingDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      renderingDefinition = renderingDefinition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IPartUsage-partDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-RenderingUsage-renderingDefinition")) {
      if (index >= 1 || renderingDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      renderingDefinition = renderingDefinition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IPartUsage-partDefinition")) {
      if (index >= partDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
