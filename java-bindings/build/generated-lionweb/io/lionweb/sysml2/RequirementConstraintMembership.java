...
public class RequirementConstraintMembership extends FeatureMembership {
  @NotNull
  private String id;
  ...
  protected RequirementConstraintKind kind;

  protected ReferenceValue ownedConstraint = null;

  protected ReferenceValue referencedConstraint = null;

  public RequirementConstraintMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getRequirementConstraintMembership();
  }
  ...
  public void setKind(RequirementConstraintKind value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("kind"), getKind(), value);
        }
    this.kind = value;
  }

  public void setOwnedConstraint(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedConstraint"), 0, ownedConstraint);
      }
      ownedConstraint = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedConstraint != null) {
          ReferenceValue oldValue = ownedConstraint;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedConstraint"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedConstraint"), 0, value);
        }
      }
      this.ownedConstraint = value;
    }
  }

  public ReferenceValue getOwnedConstraint() {
    return ownedConstraint;
  }

  public void setReferencedConstraint(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("referencedConstraint"), 0, referencedConstraint);
      }
      referencedConstraint = null;
    } else {
      if (partitionObserverCache != null) {
        if (referencedConstraint != null) {
          ReferenceValue oldValue = referencedConstraint;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("referencedConstraint"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("referencedConstraint"), 0, value);
        }
      }
      this.referencedConstraint = value;
    }
  }

  public ReferenceValue getReferencedConstraint() {
    return referencedConstraint;
  }

  @Override
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-RequirementConstraintMembership-kind")) {
      return kind;
    }
  ...
  public void setPropertyValue(Property property, Object value) {
    ...
    if (Objects.equals(property.getKey(), "sysml-RequirementConstraintMembership-kind")) {
      setKind((RequirementConstraintKind) value);
      return;
    }
    throw new IllegalStateException("Property " + property + " not found.");
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-RequirementConstraintMembership-ownedConstraint")) {
      return Collections.singletonList(ownedConstraint);
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementConstraintMembership-referencedConstraint")) {
      return Collections.singletonList(referencedConstraint);
    }
