...
public class RequirementDefinition extends ConstraintDefinition {
  @NotNull
  private String id;
  ...
  public RequirementDefinition(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getRequirementDefinition();
  }
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-RequirementDefinition-reqId")) {
      return reqId;
    }
  ...
  public List<? extends Node> getChildren(Containment containment) {
    if (Objects.equals(containment.getKey(), "sysml-RequirementDefinition-textContainer")) {
  ...
  public void addChild(@NotNull Containment containment, @NotNull Node child) {
    ...
    if (containment.getKey().equals("sysml-RequirementDefinition-textContainer")) {
