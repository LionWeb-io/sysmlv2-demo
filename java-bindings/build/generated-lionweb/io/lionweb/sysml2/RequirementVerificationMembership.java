...
public class RequirementVerificationMembership extends RequirementConstraintMembership {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedRequirement = null;

  protected ReferenceValue verifiedRequirement = null;

  public RequirementVerificationMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getRequirementVerificationMembership();
  }

  public void setOwnedRequirement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedRequirement"), 0, ownedRequirement);
      }
      ownedRequirement = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedRequirement != null) {
          ReferenceValue oldValue = ownedRequirement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedRequirement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedRequirement"), 0, value);
        }
      }
      this.ownedRequirement = value;
    }
  }

  public ReferenceValue getOwnedRequirement() {
    return ownedRequirement;
  }

  public void setVerifiedRequirement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("verifiedRequirement"), 0, verifiedRequirement);
      }
      verifiedRequirement = null;
    } else {
      if (partitionObserverCache != null) {
        if (verifiedRequirement != null) {
          ReferenceValue oldValue = verifiedRequirement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("verifiedRequirement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("verifiedRequirement"), 0, value);
        }
      }
      this.verifiedRequirement = value;
    }
  }

  public ReferenceValue getVerifiedRequirement() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-RequirementVerificationMembership-ownedRequirement")) {
      return Collections.singletonList(ownedRequirement);
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementVerificationMembership-verifiedRequirement")) {
      return Collections.singletonList(verifiedRequirement);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-RequirementVerificationMembership-ownedRequirement")) {
      ...
      setOwnedRequirement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementVerificationMembership-verifiedRequirement")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setVerifiedRequirement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementConstraintMembership-ownedConstraint")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setOwnedConstraint(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementConstraintMembership-referencedConstraint")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setReferencedConstraint(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-RequirementVerificationMembership-ownedRequirement")) {
      if (index >= 1 || ownedRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedRequirement = ownedRequirement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementVerificationMembership-verifiedRequirement")) {
      if (index >= 1 || verifiedRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      verifiedRequirement = verifiedRequirement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementConstraintMembership-ownedConstraint")) {
      if (index >= 1 || ownedConstraint == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedConstraint = ownedConstraint.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementConstraintMembership-referencedConstraint")) {
      if (index >= 1 || referencedConstraint == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      referencedConstraint = referencedConstraint.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-RequirementVerificationMembership-ownedRequirement")) {
      if (index >= 1 || ownedRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedRequirement = ownedRequirement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementVerificationMembership-verifiedRequirement")) {
      if (index >= 1 || verifiedRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      verifiedRequirement = verifiedRequirement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementConstraintMembership-ownedConstraint")) {
      if (index >= 1 || ownedConstraint == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedConstraint = ownedConstraint.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementConstraintMembership-referencedConstraint")) {
      if (index >= 1 || referencedConstraint == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      referencedConstraint = referencedConstraint.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
      if (index >= 1 || ownedMemberFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
