...
public class ResultExpressionMembership extends FeatureMembership {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedResultExpression = null;

  public ResultExpressionMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getResultExpressionMembership();
  }

  public void setOwnedResultExpression(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedResultExpression"), 0, ownedResultExpression);
      }
      ownedResultExpression = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedResultExpression != null) {
          ReferenceValue oldValue = ownedResultExpression;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedResultExpression"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedResultExpression"), 0, value);
        }
      }
      this.ownedResultExpression = value;
    }
  }

  public ReferenceValue getOwnedResultExpression() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ResultExpressionMembership-ownedResultExpression")) {
      return Collections.singletonList(ownedResultExpression);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ResultExpressionMembership-ownedResultExpression")) {
      ...
      setOwnedResultExpression(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-ResultExpressionMembership-ownedResultExpression")) {
      if (index >= 1 || ownedResultExpression == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedResultExpression = ownedResultExpression.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ResultExpressionMembership-ownedResultExpression")) {
      if (index >= 1 || ownedResultExpression == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedResultExpression = ownedResultExpression.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
      if (index >= 1 || ownedMemberFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
