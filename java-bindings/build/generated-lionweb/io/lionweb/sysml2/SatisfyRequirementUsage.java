...
public class SatisfyRequirementUsage extends RequirementUsage implements IAssertConstraintUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue satisfiedRequirement = null;

  protected ReferenceValue satisfyingFeature = null;

  protected ReferenceValue assertedConstraint = null;
  ...
  public SatisfyRequirementUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getSatisfyRequirementUsage();
  }

  public void setSatisfiedRequirement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("satisfiedRequirement"), 0, satisfiedRequirement);
      }
      satisfiedRequirement = null;
    } else {
      if (partitionObserverCache != null) {
        if (satisfiedRequirement != null) {
          ReferenceValue oldValue = satisfiedRequirement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("satisfiedRequirement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("satisfiedRequirement"), 0, value);
        }
      }
      this.satisfiedRequirement = value;
    }
  }

  public ReferenceValue getSatisfiedRequirement() {
    return satisfiedRequirement;
  }

  public void setSatisfyingFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("satisfyingFeature"), 0, satisfyingFeature);
      }
      satisfyingFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (satisfyingFeature != null) {
          ReferenceValue oldValue = satisfyingFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("satisfyingFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("satisfyingFeature"), 0, value);
        }
      }
      this.satisfyingFeature = value;
    }
  }

  public ReferenceValue getSatisfyingFeature() {
    return satisfyingFeature;
  }

  public void setAssertedConstraint(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("assertedConstraint"), 0, assertedConstraint);
      }
      assertedConstraint = null;
    } else {
      if (partitionObserverCache != null) {
        if (assertedConstraint != null) {
          ReferenceValue oldValue = assertedConstraint;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("assertedConstraint"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("assertedConstraint"), 0, value);
        }
      }
      this.assertedConstraint = value;
    }
  }

  public ReferenceValue getAssertedConstraint() {
  ...
  public void setIsNegated(Boolean value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("isNegated"), getIsNegated(), value);
        }
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-IInvariant-isNegated")) {
      return isNegated;
    }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-SatisfyRequirementUsage-satisfiedRequirement")) {
      return Collections.singletonList(satisfiedRequirement);
    }
    if (Objects.equals(reference.getKey(), "sysml-SatisfyRequirementUsage-satisfyingFeature")) {
      return Collections.singletonList(satisfyingFeature);
    }
    if (Objects.equals(reference.getKey(), "sysml-IAssertConstraintUsage-assertedConstraint")) {
      return Collections.singletonList(assertedConstraint);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-SatisfyRequirementUsage-satisfiedRequirement")) {
      ...
      setSatisfiedRequirement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-SatisfyRequirementUsage-satisfyingFeature")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setSatisfyingFeature(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IAssertConstraintUsage-assertedConstraint")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setAssertedConstraint(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-SatisfyRequirementUsage-satisfiedRequirement")) {
      if (index >= 1 || satisfiedRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      satisfiedRequirement = satisfiedRequirement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-SatisfyRequirementUsage-satisfyingFeature")) {
      if (index >= 1 || satisfyingFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      satisfyingFeature = satisfyingFeature.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IAssertConstraintUsage-assertedConstraint")) {
      if (index >= 1 || assertedConstraint == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      assertedConstraint = assertedConstraint.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementUsage-requirementDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-SatisfyRequirementUsage-satisfiedRequirement")) {
      if (index >= 1 || satisfiedRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      satisfiedRequirement = satisfiedRequirement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-SatisfyRequirementUsage-satisfyingFeature")) {
      if (index >= 1 || satisfyingFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      satisfyingFeature = satisfyingFeature.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IAssertConstraintUsage-assertedConstraint")) {
      if (index >= 1 || assertedConstraint == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      assertedConstraint = assertedConstraint.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementUsage-requirementDefinition")) {
      if (index >= 1 || requirementDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
