...
public class SendActionUsage extends AbstractNode implements HasSettableParent, IActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue senderArgument = null;
  ...
  public SendActionUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getSendActionUsage();
  }
  ...
  public void setSenderArgument(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("senderArgument"), 0, senderArgument);
      }
      senderArgument = null;
    } else {
      if (partitionObserverCache != null) {
        if (senderArgument != null) {
          ReferenceValue oldValue = senderArgument;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("senderArgument"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("senderArgument"), 0, value);
        }
      }
      this.senderArgument = value;
    }
  }

  public ReferenceValue getSenderArgument() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-SendActionUsage-receiverArgument")) {
      return Collections.singletonList(receiverArgument);
    }
    if (Objects.equals(reference.getKey(), "sysml-SendActionUsage-payloadArgument")) {
      return Collections.singletonList(payloadArgument);
    }
    if (Objects.equals(reference.getKey(), "sysml-SendActionUsage-senderArgument")) {
      return Collections.singletonList(senderArgument);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-SendActionUsage-senderArgument")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setSenderArgument(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-SendActionUsage-senderArgument")) {
      if (index >= 1 || senderArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      senderArgument = senderArgument.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-SendActionUsage-senderArgument")) {
      if (index >= 1 || senderArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      senderArgument = senderArgument.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
      if (index >= actionDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
