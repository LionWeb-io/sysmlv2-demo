...
public class Specialization extends AbstractNode implements HasSettableParent, IRelationship {
  @NotNull
  private String id;
  ...
  protected ReferenceValue general = null;

  protected ReferenceValue specific = null;
  ...
  public Specialization(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getSpecialization();
  }
  ...
  public void setGeneral(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("general"), 0, general);
      }
      general = null;
    } else {
      if (partitionObserverCache != null) {
        if (general != null) {
          ReferenceValue oldValue = general;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("general"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("general"), 0, value);
        }
      }
      this.general = value;
    }
  ...
  public ReferenceValue getGeneral() {
    return general;
  }

  public void setSpecific(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("specific"), 0, specific);
      }
      specific = null;
    } else {
      if (partitionObserverCache != null) {
        if (specific != null) {
          ReferenceValue oldValue = specific;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("specific"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("specific"), 0, value);
        }
      }
      this.specific = value;
    }
  ...
  public ReferenceValue getSpecific() {
    return specific;
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-Specialization-specific")) {
      return Collections.singletonList(specific);
    }
