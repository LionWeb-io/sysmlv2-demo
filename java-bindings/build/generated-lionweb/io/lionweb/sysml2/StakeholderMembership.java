...
public class StakeholderMembership extends ParameterMembership {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedStakeholderParameter = null;

  public StakeholderMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getStakeholderMembership();
  }

  public void setOwnedStakeholderParameter(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedStakeholderParameter"), 0, ownedStakeholderParameter);
      }
      ownedStakeholderParameter = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedStakeholderParameter != null) {
          ReferenceValue oldValue = ownedStakeholderParameter;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedStakeholderParameter"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedStakeholderParameter"), 0, value);
        }
      }
      this.ownedStakeholderParameter = value;
    }
  }

  public ReferenceValue getOwnedStakeholderParameter() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-StakeholderMembership-ownedStakeholderParameter")) {
      return Collections.singletonList(ownedStakeholderParameter);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-StakeholderMembership-ownedStakeholderParameter")) {
      ...
      setOwnedStakeholderParameter(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ParameterMembership-ownedMemberParameter")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setOwnedMemberParameter(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-StakeholderMembership-ownedStakeholderParameter")) {
      if (index >= 1 || ownedStakeholderParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedStakeholderParameter = ownedStakeholderParameter.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ParameterMembership-ownedMemberParameter")) {
      if (index >= 1 || ownedMemberParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedMemberParameter = ownedMemberParameter.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-StakeholderMembership-ownedStakeholderParameter")) {
      if (index >= 1 || ownedStakeholderParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedStakeholderParameter = ownedStakeholderParameter.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ParameterMembership-ownedMemberParameter")) {
      if (index >= 1 || ownedMemberParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedMemberParameter = ownedMemberParameter.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
      if (index >= 1 || ownedMemberFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
