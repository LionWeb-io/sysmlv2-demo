...
public class StateSubactionMembership extends FeatureMembership {
  @NotNull
  private String id;
  ...
  protected StateSubactionKind kind;

  protected ReferenceValue action = null;

  public StateSubactionMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getStateSubactionMembership();
  }
  ...
  public void setKind(StateSubactionKind value) {
  ...
  public void setAction(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("action"), 0, action);
      }
      action = null;
    } else {
      if (partitionObserverCache != null) {
        if (action != null) {
          ReferenceValue oldValue = action;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("action"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("action"), 0, value);
        }
      }
      this.action = value;
    }
  ...
  public ReferenceValue getAction() {
    return action;
  }

  @Override
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-StateSubactionMembership-kind")) {
      return kind;
    }
  ...
  public void setPropertyValue(Property property, Object value) {
    ...
    if (Objects.equals(property.getKey(), "sysml-StateSubactionMembership-kind")) {
      setKind((StateSubactionKind) value);
      return;
    }
    throw new IllegalStateException("Property " + property + " not found.");
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-StateSubactionMembership-action")) {
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-StateSubactionMembership-action")) {
      ...
      setAction(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-StateSubactionMembership-action")) {
      if (index >= 1 || action == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      action = action.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-StateSubactionMembership-action")) {
      if (index >= 1 || action == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      action = action.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
      if (index >= 1 || ownedMemberFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
