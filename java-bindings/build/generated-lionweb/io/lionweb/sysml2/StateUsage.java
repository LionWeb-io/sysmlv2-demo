...
public class StateUsage extends AbstractNode implements HasSettableParent, IActionUsage {
  @NotNull
  private String id;
  ...
  protected List<ReferenceValue> stateDefinition = new ArrayList<>();

  protected ReferenceValue entryAction = null;

  protected ReferenceValue doAction = null;

  protected ReferenceValue exitAction = null;
  ...
  public StateUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getStateUsage();
  }

  public int addToStateDefinition(ReferenceValue referenceValue, int index) {
    if (index > stateDefinition.size()) {
      throw new IllegalArgumentException("Index must be less than or equal to size");
    }
    if (partitionObserverCache != null) {
      partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("stateDefinition"), index, referenceValue);
    }
    stateDefinition.add(index, referenceValue);
    return stateDefinition.size() - 1;
  }

  public List<ReferenceValue> getStateDefinition() {
    return stateDefinition;
  }

  public int addToStateDefinition(IBehavior referred) {
    return addToStateDefinition(new ReferenceValue(referred, null), stateDefinition.size());
  }

  public int addToStateDefinition(IBehavior referred, int index) {
    return addToStateDefinition(new ReferenceValue(referred, null), index);
  }

  public void clearStateDefinition() {
    while (!stateDefinition.isEmpty()) {
            removeFromStateDefinition(0);
        };
  }

  public void removeFromStateDefinition(@NotNull ReferenceValue child) {
    int index = stateDefinition.indexOf(child);
             if (index == -1) {
                 throw new IllegalArgumentException("Child not found: " + child);
             }
             removeFromStateDefinition(index);;
  }

  public void removeFromStateDefinition(int index) {
    if (stateDefinition.size() > index) {

            ReferenceValue removed = stateDefinition.remove(index);
            if (partitionObserverCache != null) {
              partitionObserverCache.referenceValueRemoved(this, getClassifier().requireReferenceByName("stateDefinition"), index, removed);
            }
          } else {
            throw new IllegalArgumentException(
                "Invalid index "
                    ...
                    + stateDefinition.size());
          }
  }

  public void setStateDefinition(@NotNull List<? extends ReferenceValue> newValue) {
    clearStateDefinition();
          for (ReferenceValue referenceValue : newValue) {
              addToStateDefinition(referenceValue, stateDefinition.size());
          }
  }

  public void setEntryAction(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("entryAction"), 0, entryAction);
      }
      entryAction = null;
    } else {
      if (partitionObserverCache != null) {
        if (entryAction != null) {
          ReferenceValue oldValue = entryAction;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("entryAction"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("entryAction"), 0, value);
        }
      }
  ...
  public ReferenceValue getEntryAction() {
    return entryAction;
  }

  public void setDoAction(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("doAction"), 0, doAction);
      }
      doAction = null;
    } else {
      if (partitionObserverCache != null) {
        if (doAction != null) {
          ReferenceValue oldValue = doAction;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("doAction"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("doAction"), 0, value);
        }
      }
      this.doAction = value;
    }
  ...
  public ReferenceValue getDoAction() {
    return doAction;
  }

  public void setExitAction(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("exitAction"), 0, exitAction);
      }
      exitAction = null;
    } else {
      if (partitionObserverCache != null) {
        if (exitAction != null) {
          ReferenceValue oldValue = exitAction;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("exitAction"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("exitAction"), 0, value);
        }
      }
  ...
  public ReferenceValue getExitAction() {
    return exitAction;
  }
  ...
  public void setIsParallel(Boolean value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("isParallel"), getIsParallel(), value);
        }
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-StateUsage-isParallel")) {
      return isParallel;
    }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-stateDefinition")) {
      return stateDefinition;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-entryAction")) {
      return Collections.singletonList(entryAction);
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-doAction")) {
      return Collections.singletonList(doAction);
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-exitAction")) {
      return Collections.singletonList(exitAction);
    }
  ...
  public int addReferenceValue(Reference reference, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-stateDefinition")) {
      return addToStateDefinition(referredNode, stateDefinition.size());
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public int addReferenceValue(Reference reference, int index, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-stateDefinition")) {
      return addToStateDefinition(referredNode, index);
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-stateDefinition")) {
      setStateDefinition(values);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-entryAction")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setEntryAction(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-doAction")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setDoAction(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-exitAction")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setExitAction(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-stateDefinition")) {
      if (index >= stateDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = stateDefinition.get(index);
      stateDefinition.set(index, original.withReferred(referredNode));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-entryAction")) {
      if (index >= 1 || entryAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      entryAction = entryAction.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-doAction")) {
      if (index >= 1 || doAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      doAction = doAction.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-exitAction")) {
      if (index >= 1 || exitAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      exitAction = exitAction.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-stateDefinition")) {
      if (index >= stateDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = stateDefinition.get(index);
      stateDefinition.set(index, original.withResolveInfo(resolveInfo));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-entryAction")) {
      if (index >= 1 || entryAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      entryAction = entryAction.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-doAction")) {
      if (index >= 1 || doAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      doAction = doAction.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-StateUsage-exitAction")) {
      if (index >= 1 || exitAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      exitAction = exitAction.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
      if (index >= actionDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
