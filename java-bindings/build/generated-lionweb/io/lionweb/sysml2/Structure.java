...
public class Structure extends AbstractNode implements HasSettableParent, IStructure {
  @NotNull
  private String id;
  ...
  public Structure(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getStructure();
  }
