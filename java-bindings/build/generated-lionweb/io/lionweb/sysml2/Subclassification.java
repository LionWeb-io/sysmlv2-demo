...
public class Subclassification extends Specialization {
  @NotNull
  private String id;
  ...
  protected ReferenceValue superclassifier = null;

  protected ReferenceValue owningClassifier = null;

  protected ReferenceValue subclassifier = null;

  public Subclassification(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getSubclassification();
  }

  public void setSuperclassifier(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("superclassifier"), 0, superclassifier);
      }
      superclassifier = null;
    } else {
      if (partitionObserverCache != null) {
        if (superclassifier != null) {
          ReferenceValue oldValue = superclassifier;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("superclassifier"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("superclassifier"), 0, value);
        }
      }
      this.superclassifier = value;
    }
  }

  public ReferenceValue getSuperclassifier() {
    return superclassifier;
  }

  public void setOwningClassifier(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("owningClassifier"), 0, owningClassifier);
      }
      owningClassifier = null;
    } else {
      if (partitionObserverCache != null) {
        if (owningClassifier != null) {
          ReferenceValue oldValue = owningClassifier;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("owningClassifier"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("owningClassifier"), 0, value);
        }
      }
      this.owningClassifier = value;
    }
  }

  public ReferenceValue getOwningClassifier() {
    return owningClassifier;
  }

  public void setSubclassifier(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("subclassifier"), 0, subclassifier);
      }
      subclassifier = null;
    } else {
      if (partitionObserverCache != null) {
        if (subclassifier != null) {
          ReferenceValue oldValue = subclassifier;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("subclassifier"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("subclassifier"), 0, value);
        }
      }
      this.subclassifier = value;
    }
  }

  public ReferenceValue getSubclassifier() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-superclassifier")) {
      return Collections.singletonList(superclassifier);
    }
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-owningClassifier")) {
      return Collections.singletonList(owningClassifier);
    }
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-subclassifier")) {
      return Collections.singletonList(subclassifier);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-superclassifier")) {
      ...
      setSuperclassifier(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-owningClassifier")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setOwningClassifier(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-subclassifier")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setSubclassifier(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-superclassifier")) {
      if (index >= 1 || superclassifier == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      superclassifier = superclassifier.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-owningClassifier")) {
      if (index >= 1 || owningClassifier == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      owningClassifier = owningClassifier.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-subclassifier")) {
      if (index >= 1 || subclassifier == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      subclassifier = subclassifier.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Specialization-owningType")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-superclassifier")) {
      if (index >= 1 || superclassifier == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      superclassifier = superclassifier.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-owningClassifier")) {
      if (index >= 1 || owningClassifier == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      owningClassifier = owningClassifier.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Subclassification-subclassifier")) {
      if (index >= 1 || subclassifier == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      subclassifier = subclassifier.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-Specialization-owningType")) {
      if (index >= 1 || owningType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
