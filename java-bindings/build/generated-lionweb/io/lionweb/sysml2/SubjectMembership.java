...
public class SubjectMembership extends ParameterMembership {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedSubjectParameter = null;

  public SubjectMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getSubjectMembership();
  }

  public void setOwnedSubjectParameter(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedSubjectParameter"), 0, ownedSubjectParameter);
      }
      ownedSubjectParameter = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedSubjectParameter != null) {
          ReferenceValue oldValue = ownedSubjectParameter;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedSubjectParameter"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedSubjectParameter"), 0, value);
        }
      }
      this.ownedSubjectParameter = value;
    }
  }

  public ReferenceValue getOwnedSubjectParameter() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-SubjectMembership-ownedSubjectParameter")) {
      return Collections.singletonList(ownedSubjectParameter);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-SubjectMembership-ownedSubjectParameter")) {
      ...
      setOwnedSubjectParameter(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-SubjectMembership-ownedSubjectParameter")) {
      if (index >= 1 || ownedSubjectParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedSubjectParameter = ownedSubjectParameter.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ParameterMembership-ownedMemberParameter")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-SubjectMembership-ownedSubjectParameter")) {
      if (index >= 1 || ownedSubjectParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedSubjectParameter = ownedSubjectParameter.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ParameterMembership-ownedMemberParameter")) {
      if (index >= 1 || ownedMemberParameter == null) throw new IllegalArgumentException("index should be less than the size of the list");;
