...
public class Succession extends AbstractNode implements HasSettableParent, ISuccession {
  @NotNull
  private String id;
  ...
  public Succession(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getSuccession();
  }
