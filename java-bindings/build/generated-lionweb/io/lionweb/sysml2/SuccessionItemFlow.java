...
public class SuccessionItemFlow extends AbstractNode implements HasSettableParent, ISuccessionItemFlow {
  @NotNull
  private String id;
  ...
  public SuccessionItemFlow(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getSuccessionItemFlow();
  }
