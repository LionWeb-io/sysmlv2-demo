...
public class TerminateActionUsage extends AbstractNode implements HasSettableParent, IActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue terminatedOccurrenceArgument = null;
  ...
  public TerminateActionUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getTerminateActionUsage();
  }

  public void setTerminatedOccurrenceArgument(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("terminatedOccurrenceArgument"), 0, terminatedOccurrenceArgument);
      }
      terminatedOccurrenceArgument = null;
    } else {
      if (partitionObserverCache != null) {
        if (terminatedOccurrenceArgument != null) {
          ReferenceValue oldValue = terminatedOccurrenceArgument;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("terminatedOccurrenceArgument"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("terminatedOccurrenceArgument"), 0, value);
        }
      }
      this.terminatedOccurrenceArgument = value;
    }
  }

  public ReferenceValue getTerminatedOccurrenceArgument() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-TerminateActionUsage-terminatedOccurrenceArgument")) {
      return Collections.singletonList(terminatedOccurrenceArgument);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-TerminateActionUsage-terminatedOccurrenceArgument")) {
      ...
      setTerminatedOccurrenceArgument(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-TerminateActionUsage-terminatedOccurrenceArgument")) {
      if (index >= 1 || terminatedOccurrenceArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      terminatedOccurrenceArgument = terminatedOccurrenceArgument.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-TerminateActionUsage-terminatedOccurrenceArgument")) {
      if (index >= 1 || terminatedOccurrenceArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      terminatedOccurrenceArgument = terminatedOccurrenceArgument.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
      if (index >= actionDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
