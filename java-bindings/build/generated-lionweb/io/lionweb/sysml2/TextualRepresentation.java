...
public class TextualRepresentation extends AbstractNode implements HasSettableParent, IAnnotatingElement {
  @NotNull
  private String id;
  ...
  protected ReferenceValue representedElement = null;

  protected List<ReferenceValue> annotatedElement = new ArrayList<>();

  protected List<ReferenceValue> ownedAnnotatingRelationship = new ArrayList<>();

  protected List<ReferenceValue> annotation = new ArrayList<>();

  protected ReferenceValue owningAnnotatingRelationship = null;
  ...
  public TextualRepresentation(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getTextualRepresentation();
  }
  ...
  public void setLanguage(String value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("language"), getLanguage(), value);
        }
    this.language = value;
  }
  ...
  public void setBody(String value) {
    if (partitionObserverCache != null) {
          partitionObserverCache.propertyChanged(
              this, this.getClassifier().requirePropertyByName("body"), getBody(), value);
        }
    this.body = value;
  }

  public void setRepresentedElement(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("representedElement"), 0, representedElement);
      }
      representedElement = null;
    } else {
      if (partitionObserverCache != null) {
        if (representedElement != null) {
          ReferenceValue oldValue = representedElement;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("representedElement"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("representedElement"), 0, value);
        }
      }
  ...
  public ReferenceValue getRepresentedElement() {
    return representedElement;
  }

  public int addToAnnotatedElement(ReferenceValue referenceValue, int index) {
    if (index > annotatedElement.size()) {
      throw new IllegalArgumentException("Index must be less than or equal to size");
    }
    if (partitionObserverCache != null) {
      partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("annotatedElement"), index, referenceValue);
    }
    annotatedElement.add(index, referenceValue);
    return annotatedElement.size() - 1;
  }

  public List<ReferenceValue> getAnnotatedElement() {
    return annotatedElement;
  }

  public int addToAnnotatedElement(IElement referred) {
    return addToAnnotatedElement(new ReferenceValue(referred, null), annotatedElement.size());
  }

  public int addToAnnotatedElement(IElement referred, int index) {
    return addToAnnotatedElement(new ReferenceValue(referred, null), index);
  }

  public void clearAnnotatedElement() {
    while (!annotatedElement.isEmpty()) {
            removeFromAnnotatedElement(0);
        };
  }

  public void removeFromAnnotatedElement(@NotNull ReferenceValue child) {
    int index = annotatedElement.indexOf(child);
             if (index == -1) {
                 throw new IllegalArgumentException("Child not found: " + child);
             }
             removeFromAnnotatedElement(index);;
  }

  public void removeFromAnnotatedElement(int index) {
    if (annotatedElement.size() > index) {

            ReferenceValue removed = annotatedElement.remove(index);
            if (partitionObserverCache != null) {
              partitionObserverCache.referenceValueRemoved(this, getClassifier().requireReferenceByName("annotatedElement"), index, removed);
            }
          } else {
            throw new IllegalArgumentException(
                "Invalid index "
                    ...
                    + annotatedElement.size());
          }
  }

  public void setAnnotatedElement(@NotNull List<? extends ReferenceValue> newValue) {
    clearAnnotatedElement();
          for (ReferenceValue referenceValue : newValue) {
              addToAnnotatedElement(referenceValue, annotatedElement.size());
          }
  }

  public int addToOwnedAnnotatingRelationship(ReferenceValue referenceValue, int index) {
    if (index > ownedAnnotatingRelationship.size()) {
      throw new IllegalArgumentException("Index must be less than or equal to size");
    }
    if (partitionObserverCache != null) {
      partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedAnnotatingRelationship"), index, referenceValue);
    }
    ownedAnnotatingRelationship.add(index, referenceValue);
    return ownedAnnotatingRelationship.size() - 1;
  }

  public List<ReferenceValue> getOwnedAnnotatingRelationship() {
    return ownedAnnotatingRelationship;
  }

  public int addToOwnedAnnotatingRelationship(Annotation referred) {
    return addToOwnedAnnotatingRelationship(new ReferenceValue(referred, null), ownedAnnotatingRelationship.size());
  }

  public int addToOwnedAnnotatingRelationship(Annotation referred, int index) {
    return addToOwnedAnnotatingRelationship(new ReferenceValue(referred, null), index);
  }

  public void clearOwnedAnnotatingRelationship() {
    while (!ownedAnnotatingRelationship.isEmpty()) {
            removeFromOwnedAnnotatingRelationship(0);
        };
  }

  public void removeFromOwnedAnnotatingRelationship(@NotNull ReferenceValue child) {
    int index = ownedAnnotatingRelationship.indexOf(child);
             if (index == -1) {
                 throw new IllegalArgumentException("Child not found: " + child);
             }
             removeFromOwnedAnnotatingRelationship(index);;
  }

  public void removeFromOwnedAnnotatingRelationship(int index) {
    if (ownedAnnotatingRelationship.size() > index) {

            ReferenceValue removed = ownedAnnotatingRelationship.remove(index);
            if (partitionObserverCache != null) {
              partitionObserverCache.referenceValueRemoved(this, getClassifier().requireReferenceByName("ownedAnnotatingRelationship"), index, removed);
            }
          } else {
            throw new IllegalArgumentException(
                "Invalid index "
                    + index
                    + " when reference values are "
                    + ownedAnnotatingRelationship.size());
          }
  }

  public void setOwnedAnnotatingRelationship(@NotNull List<? extends ReferenceValue> newValue) {
    clearOwnedAnnotatingRelationship();
          for (ReferenceValue referenceValue : newValue) {
              addToOwnedAnnotatingRelationship(referenceValue, ownedAnnotatingRelationship.size());
          }
  }

  public int addToAnnotation(ReferenceValue referenceValue, int index) {
    if (index > annotation.size()) {
      throw new IllegalArgumentException("Index must be less than or equal to size");
    }
    if (partitionObserverCache != null) {
      partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("annotation"), index, referenceValue);
    }
    annotation.add(index, referenceValue);
    return annotation.size() - 1;
  }

  public List<ReferenceValue> getAnnotation() {
    return annotation;
  }

  public int addToAnnotation(Annotation referred) {
    return addToAnnotation(new ReferenceValue(referred, null), annotation.size());
  }

  public int addToAnnotation(Annotation referred, int index) {
    return addToAnnotation(new ReferenceValue(referred, null), index);
  }

  public void clearAnnotation() {
    while (!annotation.isEmpty()) {
            removeFromAnnotation(0);
        };
  }

  public void removeFromAnnotation(@NotNull ReferenceValue child) {
    int index = annotation.indexOf(child);
             if (index == -1) {
                 throw new IllegalArgumentException("Child not found: " + child);
             }
  ...
  public void removeFromAnnotation(int index) {
    if (annotation.size() > index) {

            ReferenceValue removed = annotation.remove(index);
            if (partitionObserverCache != null) {
              partitionObserverCache.referenceValueRemoved(this, getClassifier().requireReferenceByName("annotation"), index, removed);
            }
          } else {
            throw new IllegalArgumentException(
                "Invalid index "
  ...
  public void setAnnotation(@NotNull List<? extends ReferenceValue> newValue) {
    clearAnnotation();
          for (ReferenceValue referenceValue : newValue) {
              addToAnnotation(referenceValue, annotation.size());
          }
  }

  public void setOwningAnnotatingRelationship(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("owningAnnotatingRelationship"), 0, owningAnnotatingRelationship);
      }
      owningAnnotatingRelationship = null;
    } else {
      if (partitionObserverCache != null) {
        if (owningAnnotatingRelationship != null) {
          ReferenceValue oldValue = owningAnnotatingRelationship;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("owningAnnotatingRelationship"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("owningAnnotatingRelationship"), 0, value);
        }
      }
      this.owningAnnotatingRelationship = value;
    }
  }

  public ReferenceValue getOwningAnnotatingRelationship() {
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-TextualRepresentation-language")) {
      return language;
    }
    if (Objects.equals(property.getKey(), "sysml-TextualRepresentation-body")) {
      return body;
    }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-TextualRepresentation-representedElement")) {
      return Collections.singletonList(representedElement);
    }
    ...
    if (Objects.equals(reference.getKey(), "sysml-IAnnotatingElement-owningAnnotatingRelationship")) {
      return Collections.singletonList(owningAnnotatingRelationship);
    }
  ...
  public int addReferenceValue(Reference reference, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-IAnnotatingElement-annotatedElement")) {
      return addToAnnotatedElement(referredNode, annotatedElement.size());
    }
    if (Objects.equals(reference.getKey(), "sysml-IAnnotatingElement-ownedAnnotatingRelationship")) {
      return addToOwnedAnnotatingRelationship(referredNode, ownedAnnotatingRelationship.size());
    }
    if (Objects.equals(reference.getKey(), "sysml-IAnnotatingElement-annotation")) {
      return addToAnnotation(referredNode, annotation.size());
    }
    if (Objects.equals(reference.getKey(), "sysml-IElement-ownedElement")) {
  ...
  public int addReferenceValue(Reference reference, int index, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-IAnnotatingElement-annotatedElement")) {
      return addToAnnotatedElement(referredNode, index);
    }
    if (Objects.equals(reference.getKey(), "sysml-IAnnotatingElement-ownedAnnotatingRelationship")) {
      return addToOwnedAnnotatingRelationship(referredNode, index);
    }
    if (Objects.equals(reference.getKey(), "sysml-IAnnotatingElement-annotation")) {
      return addToAnnotation(referredNode, index);
    }
    if (Objects.equals(reference.getKey(), "sysml-IElement-ownedElement")) {
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-TextualRepresentation-representedElement")) {
      ...
      setRepresentedElement(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IAnnotatingElement-annotatedElement")) {
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-TextualRepresentation-representedElement")) {
      if (index >= 1 || representedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      representedElement = representedElement.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IAnnotatingElement-annotatedElement")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-TextualRepresentation-representedElement")) {
      if (index >= 1 || representedElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      representedElement = representedElement.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IAnnotatingElement-annotatedElement")) {
      if (index >= annotatedElement.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
