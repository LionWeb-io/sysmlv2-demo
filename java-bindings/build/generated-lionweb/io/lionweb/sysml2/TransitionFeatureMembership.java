...
public class TransitionFeatureMembership extends FeatureMembership {
  @NotNull
  private String id;
  ...
  protected TransitionFeatureKind kind;

  protected ReferenceValue transitionFeature = null;

  public TransitionFeatureMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getTransitionFeatureMembership();
  }
  ...
  public void setKind(TransitionFeatureKind value) {
  ...
  public void setTransitionFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("transitionFeature"), 0, transitionFeature);
      }
      transitionFeature = null;
    } else {
      if (partitionObserverCache != null) {
        if (transitionFeature != null) {
          ReferenceValue oldValue = transitionFeature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("transitionFeature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("transitionFeature"), 0, value);
        }
      }
      this.transitionFeature = value;
    }
  }

  public ReferenceValue getTransitionFeature() {
    return transitionFeature;
  }

  @Override
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-TransitionFeatureMembership-kind")) {
      return kind;
    }
  ...
  public void setPropertyValue(Property property, Object value) {
    ...
    if (Objects.equals(property.getKey(), "sysml-TransitionFeatureMembership-kind")) {
      setKind((TransitionFeatureKind) value);
      return;
    }
    throw new IllegalStateException("Property " + property + " not found.");
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-TransitionFeatureMembership-transitionFeature")) {
      return Collections.singletonList(transitionFeature);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-TransitionFeatureMembership-transitionFeature")) {
      ...
      setTransitionFeature(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-TransitionFeatureMembership-transitionFeature")) {
      if (index >= 1 || transitionFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      transitionFeature = transitionFeature.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-TransitionFeatureMembership-transitionFeature")) {
      if (index >= 1 || transitionFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      transitionFeature = transitionFeature.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-FeatureMembership-ownedMemberFeature")) {
      if (index >= 1 || ownedMemberFeature == null) throw new IllegalArgumentException("index should be less than the size of the list");;
