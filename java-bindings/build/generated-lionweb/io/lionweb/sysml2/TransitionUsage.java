...
public class TransitionUsage extends AbstractNode implements HasSettableParent, IActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue source = null;

  protected ReferenceValue target = null;

  protected List<ReferenceValue> triggerAction = new ArrayList<>();

  protected List<ReferenceValue> guardExpression = new ArrayList<>();

  protected List<ReferenceValue> effectAction = new ArrayList<>();

  protected ReferenceValue succession = null;

  protected List<ReferenceValue> actionDefinition = new ArrayList<>();
  ...
  public TransitionUsage(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getTransitionUsage();
  }

  public void setSource(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("source"), 0, source);
      }
      source = null;
    } else {
      if (partitionObserverCache != null) {
        if (source != null) {
          ReferenceValue oldValue = source;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("source"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("source"), 0, value);
        }
      }
      this.source = value;
    }
  ...
  public void setTarget(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("target"), 0, target);
      }
      target = null;
    } else {
      if (partitionObserverCache != null) {
        if (target != null) {
          ReferenceValue oldValue = target;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("target"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("target"), 0, value);
        }
      }
      this.target = value;
    }
  ...
  public ReferenceValue getTarget() {
    return target;
  }

  public int addToTriggerAction(ReferenceValue referenceValue, int index) {
    if (index > triggerAction.size()) {
      throw new IllegalArgumentException("Index must be less than or equal to size");
    }
    if (partitionObserverCache != null) {
      partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("triggerAction"), index, referenceValue);
    }
    triggerAction.add(index, referenceValue);
    return triggerAction.size() - 1;
  }

  public List<ReferenceValue> getTriggerAction() {
    return triggerAction;
  }

  public int addToTriggerAction(AcceptActionUsage referred) {
    return addToTriggerAction(new ReferenceValue(referred, null), triggerAction.size());
  }

  public int addToTriggerAction(AcceptActionUsage referred, int index) {
    return addToTriggerAction(new ReferenceValue(referred, null), index);
  }

  public void clearTriggerAction() {
    while (!triggerAction.isEmpty()) {
            removeFromTriggerAction(0);
        };
  }

  public void removeFromTriggerAction(@NotNull ReferenceValue child) {
    int index = triggerAction.indexOf(child);
             if (index == -1) {
                 throw new IllegalArgumentException("Child not found: " + child);
             }
             removeFromTriggerAction(index);;
  }

  public void removeFromTriggerAction(int index) {
    if (triggerAction.size() > index) {

            ReferenceValue removed = triggerAction.remove(index);
            if (partitionObserverCache != null) {
              partitionObserverCache.referenceValueRemoved(this, getClassifier().requireReferenceByName("triggerAction"), index, removed);
            }
          } else {
  ...
  public void setTriggerAction(@NotNull List<? extends ReferenceValue> newValue) {
    clearTriggerAction();
          for (ReferenceValue referenceValue : newValue) {
              addToTriggerAction(referenceValue, triggerAction.size());
          }
  }
  ...
  public int addToEffectAction(ReferenceValue referenceValue, int index) {
    if (index > effectAction.size()) {
      throw new IllegalArgumentException("Index must be less than or equal to size");
    }
    if (partitionObserverCache != null) {
      partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("effectAction"), index, referenceValue);
    }
    effectAction.add(index, referenceValue);
    return effectAction.size() - 1;
  }

  public List<ReferenceValue> getEffectAction() {
    return effectAction;
  }

  public int addToEffectAction(IActionUsage referred) {
    return addToEffectAction(new ReferenceValue(referred, null), effectAction.size());
  }

  public int addToEffectAction(IActionUsage referred, int index) {
    return addToEffectAction(new ReferenceValue(referred, null), index);
  }

  public void clearEffectAction() {
    while (!effectAction.isEmpty()) {
            removeFromEffectAction(0);
        };
  }

  public void removeFromEffectAction(@NotNull ReferenceValue child) {
    int index = effectAction.indexOf(child);
             if (index == -1) {
                 throw new IllegalArgumentException("Child not found: " + child);
             }
             removeFromEffectAction(index);;
  }

  public void removeFromEffectAction(int index) {
    if (effectAction.size() > index) {

            ReferenceValue removed = effectAction.remove(index);
            if (partitionObserverCache != null) {
              partitionObserverCache.referenceValueRemoved(this, getClassifier().requireReferenceByName("effectAction"), index, removed);
            }
          } else {
            throw new IllegalArgumentException(
                "Invalid index "
  ...
  public void setEffectAction(@NotNull List<? extends ReferenceValue> newValue) {
    clearEffectAction();
          for (ReferenceValue referenceValue : newValue) {
              addToEffectAction(referenceValue, effectAction.size());
          }
  }

  public void setSuccession(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("succession"), 0, succession);
      }
      succession = null;
    } else {
      if (partitionObserverCache != null) {
        if (succession != null) {
          ReferenceValue oldValue = succession;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("succession"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("succession"), 0, value);
        }
      }
  ...
  public ReferenceValue getSuccession() {
    return succession;
  }

  public int addToActionDefinition(ReferenceValue referenceValue, int index) {
    if (index > actionDefinition.size()) {
      throw new IllegalArgumentException("Index must be less than or equal to size");
    }
    if (partitionObserverCache != null) {
      partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("actionDefinition"), index, referenceValue);
    }
    actionDefinition.add(index, referenceValue);
    return actionDefinition.size() - 1;
  }

  public List<ReferenceValue> getActionDefinition() {
    return actionDefinition;
  }

  public int addToActionDefinition(IBehavior referred) {
    return addToActionDefinition(new ReferenceValue(referred, null), actionDefinition.size());
  }

  public int addToActionDefinition(IBehavior referred, int index) {
    return addToActionDefinition(new ReferenceValue(referred, null), index);
  }

  public void clearActionDefinition() {
    while (!actionDefinition.isEmpty()) {
            removeFromActionDefinition(0);
        };
  }

  public void removeFromActionDefinition(@NotNull ReferenceValue child) {
    int index = actionDefinition.indexOf(child);
             if (index == -1) {
                 throw new IllegalArgumentException("Child not found: " + child);
             }
             removeFromActionDefinition(index);;
  }

  public void removeFromActionDefinition(int index) {
    if (actionDefinition.size() > index) {

            ReferenceValue removed = actionDefinition.remove(index);
            if (partitionObserverCache != null) {
              partitionObserverCache.referenceValueRemoved(this, getClassifier().requireReferenceByName("actionDefinition"), index, removed);
            }
          } else {
            throw new IllegalArgumentException(
                "Invalid index "
                    + index
                    + " when reference values are "
                    + actionDefinition.size());
          }
  }

  public void setActionDefinition(@NotNull List<? extends ReferenceValue> newValue) {
    clearActionDefinition();
          for (ReferenceValue referenceValue : newValue) {
              addToActionDefinition(referenceValue, actionDefinition.size());
          }
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-source")) {
      return Collections.singletonList(source);
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-target")) {
      return Collections.singletonList(target);
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-triggerAction")) {
      return triggerAction;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-guardExpression")) {
      return guardExpression;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-effectAction")) {
      return effectAction;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-succession")) {
      return Collections.singletonList(succession);
    }
  ...
  public int addReferenceValue(Reference reference, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-triggerAction")) {
      return addToTriggerAction(referredNode, triggerAction.size());
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-guardExpression")) {
      return addToGuardExpression(referredNode, guardExpression.size());
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-effectAction")) {
      return addToEffectAction(referredNode, effectAction.size());
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
      return addToActionDefinition(referredNode, actionDefinition.size());
    }
    if (Objects.equals(reference.getKey(), "sysml-IOccurrenceUsage-occurrenceDefinition")) {
  ...
  public int addReferenceValue(Reference reference, int index, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-triggerAction")) {
      return addToTriggerAction(referredNode, index);
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-guardExpression")) {
      return addToGuardExpression(referredNode, index);
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-effectAction")) {
      return addToEffectAction(referredNode, index);
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
      return addToActionDefinition(referredNode, index);
    }
    if (Objects.equals(reference.getKey(), "sysml-IOccurrenceUsage-occurrenceDefinition")) {
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-source")) {
      ...
      setSource(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-target")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setTarget(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-triggerAction")) {
      setTriggerAction(values);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-guardExpression")) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-effectAction")) {
      setEffectAction(values);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-succession")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setSuccession(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-source")) {
      if (index >= 1 || source == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      source = source.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-target")) {
      if (index >= 1 || target == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      target = target.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-triggerAction")) {
      if (index >= triggerAction.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = triggerAction.get(index);
      triggerAction.set(index, original.withReferred(referredNode));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-guardExpression")) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-effectAction")) {
      if (index >= effectAction.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = effectAction.get(index);
      effectAction.set(index, original.withReferred(referredNode));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-succession")) {
      if (index >= 1 || succession == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      succession = succession.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-source")) {
      if (index >= 1 || source == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      source = source.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-target")) {
      if (index >= 1 || target == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      target = target.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-triggerAction")) {
      if (index >= triggerAction.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = triggerAction.get(index);
      triggerAction.set(index, original.withResolveInfo(resolveInfo));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-guardExpression")) {
      if (index >= guardExpression.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
    ...
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-effectAction")) {
      if (index >= effectAction.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = effectAction.get(index);
      effectAction.set(index, original.withResolveInfo(resolveInfo));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TransitionUsage-succession")) {
      if (index >= 1 || succession == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      succession = succession.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
      if (index >= actionDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
