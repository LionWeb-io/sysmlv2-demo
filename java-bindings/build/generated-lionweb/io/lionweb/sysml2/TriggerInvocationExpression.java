...
public class TriggerInvocationExpression extends InvocationExpression {
  @NotNull
  private String id;
  ...
  protected TriggerKind kind;

  public TriggerInvocationExpression(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getTriggerInvocationExpression();
  }
  ...
  public void setKind(TriggerKind value) {
  ...
  public Object getPropertyValue(Property property) {
    if (Objects.equals(property.getKey(), "sysml-TriggerInvocationExpression-kind")) {
      return kind;
    }
