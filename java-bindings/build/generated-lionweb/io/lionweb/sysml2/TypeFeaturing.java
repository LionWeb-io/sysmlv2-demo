...
public class TypeFeaturing extends AbstractNode implements HasSettableParent, IFeaturing {
  @NotNull
  private String id;
  ...
  protected ReferenceValue featureOfType = null;

  protected ReferenceValue featuringType = null;

  protected ReferenceValue owningFeatureOfType = null;

  protected ReferenceValue type = null;

  protected ReferenceValue feature = null;
  ...
  public TypeFeaturing(@NotNull String id) {
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getTypeFeaturing();
  }

  public void setFeatureOfType(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("featureOfType"), 0, featureOfType);
      }
      featureOfType = null;
    } else {
      if (partitionObserverCache != null) {
        if (featureOfType != null) {
          ReferenceValue oldValue = featureOfType;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("featureOfType"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("featureOfType"), 0, value);
        }
      }
      this.featureOfType = value;
    }
  }

  public ReferenceValue getFeatureOfType() {
    return featureOfType;
  }

  public void setFeaturingType(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("featuringType"), 0, featuringType);
      }
      featuringType = null;
    } else {
      if (partitionObserverCache != null) {
        if (featuringType != null) {
          ReferenceValue oldValue = featuringType;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("featuringType"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("featuringType"), 0, value);
        }
      }
      this.featuringType = value;
    }
  }

  public ReferenceValue getFeaturingType() {
    return featuringType;
  }

  public void setOwningFeatureOfType(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("owningFeatureOfType"), 0, owningFeatureOfType);
      }
      owningFeatureOfType = null;
    } else {
      if (partitionObserverCache != null) {
        if (owningFeatureOfType != null) {
          ReferenceValue oldValue = owningFeatureOfType;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("owningFeatureOfType"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("owningFeatureOfType"), 0, value);
        }
      }
      this.owningFeatureOfType = value;
    }
  }

  public ReferenceValue getOwningFeatureOfType() {
  ...
  public void setType(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("type"), 0, type);
      }
      type = null;
    } else {
      if (partitionObserverCache != null) {
        if (type != null) {
          ReferenceValue oldValue = type;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("type"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("type"), 0, value);
        }
      }
      this.type = value;
    }
  ...
  public void setFeature(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("feature"), 0, feature);
      }
      feature = null;
    } else {
      if (partitionObserverCache != null) {
        if (feature != null) {
          ReferenceValue oldValue = feature;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("feature"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("feature"), 0, value);
        }
      }
      this.feature = value;
    }
  ...
  public ReferenceValue getFeature() {
    return feature;
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-featureOfType")) {
      return Collections.singletonList(featureOfType);
    }
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-featuringType")) {
      return Collections.singletonList(featuringType);
    }
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-owningFeatureOfType")) {
      return Collections.singletonList(owningFeatureOfType);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-featureOfType")) {
      ...
      setFeatureOfType(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-featuringType")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setFeaturingType(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-owningFeatureOfType")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setOwningFeatureOfType(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IFeaturing-type")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-featureOfType")) {
      if (index >= 1 || featureOfType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      featureOfType = featureOfType.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-featuringType")) {
      if (index >= 1 || featuringType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      featuringType = featuringType.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-owningFeatureOfType")) {
      if (index >= 1 || owningFeatureOfType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      owningFeatureOfType = owningFeatureOfType.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IFeaturing-type")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-featureOfType")) {
      if (index >= 1 || featureOfType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      featureOfType = featureOfType.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-featuringType")) {
      if (index >= 1 || featuringType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      featuringType = featuringType.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-TypeFeaturing-owningFeatureOfType")) {
      if (index >= 1 || owningFeatureOfType == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      owningFeatureOfType = owningFeatureOfType.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IFeaturing-type")) {
      if (index >= 1 || type == null) throw new IllegalArgumentException("index should be less than the size of the list");;
