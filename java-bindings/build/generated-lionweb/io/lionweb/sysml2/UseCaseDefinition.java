...
public class UseCaseDefinition extends CaseDefinition {
  @NotNull
  private String id;
  ...
  public UseCaseDefinition(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getUseCaseDefinition();
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-UseCaseDefinition-includedUseCase")) {
      return includedUseCase;
    }
