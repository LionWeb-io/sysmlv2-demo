...
public class VariantMembership extends OwningMembership {
  @NotNull
  private String id;
  ...
  protected ReferenceValue ownedVariantUsage = null;

  public VariantMembership(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getVariantMembership();
  }

  public void setOwnedVariantUsage(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("ownedVariantUsage"), 0, ownedVariantUsage);
      }
      ownedVariantUsage = null;
    } else {
      if (partitionObserverCache != null) {
        if (ownedVariantUsage != null) {
          ReferenceValue oldValue = ownedVariantUsage;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("ownedVariantUsage"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("ownedVariantUsage"), 0, value);
        }
      }
      this.ownedVariantUsage = value;
    }
  }

  public ReferenceValue getOwnedVariantUsage() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-VariantMembership-ownedVariantUsage")) {
      return Collections.singletonList(ownedVariantUsage);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-VariantMembership-ownedVariantUsage")) {
      ...
      setOwnedVariantUsage(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-VariantMembership-ownedVariantUsage")) {
      if (index >= 1 || ownedVariantUsage == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedVariantUsage = ownedVariantUsage.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-OwningMembership-ownedMemberElement")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-VariantMembership-ownedVariantUsage")) {
      if (index >= 1 || ownedVariantUsage == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      ownedVariantUsage = ownedVariantUsage.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-OwningMembership-ownedMemberElement")) {
      if (index >= 1 || ownedMemberElement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
