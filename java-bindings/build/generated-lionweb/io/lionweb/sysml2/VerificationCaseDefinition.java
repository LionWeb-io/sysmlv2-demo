...
public class VerificationCaseDefinition extends CaseDefinition {
  @NotNull
  private String id;
  ...
  public VerificationCaseDefinition(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getVerificationCaseDefinition();
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseDefinition-verifiedRequirement")) {
      return verifiedRequirement;
    }
