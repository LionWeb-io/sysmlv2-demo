...
public class VerificationCaseUsage extends CaseUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue verificationCaseDefinition = null;

  protected List<ReferenceValue> verifiedRequirement = new ArrayList<>();

  public VerificationCaseUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getVerificationCaseUsage();
  }

  public void setVerificationCaseDefinition(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("verificationCaseDefinition"), 0, verificationCaseDefinition);
      }
      verificationCaseDefinition = null;
    } else {
      if (partitionObserverCache != null) {
        if (verificationCaseDefinition != null) {
          ReferenceValue oldValue = verificationCaseDefinition;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("verificationCaseDefinition"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("verificationCaseDefinition"), 0, value);
        }
      }
      this.verificationCaseDefinition = value;
    }
  }

  public ReferenceValue getVerificationCaseDefinition() {
    return verificationCaseDefinition;
  }

  public int addToVerifiedRequirement(ReferenceValue referenceValue, int index) {
    if (index > verifiedRequirement.size()) {
      throw new IllegalArgumentException("Index must be less than or equal to size");
    }
    if (partitionObserverCache != null) {
      partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("verifiedRequirement"), index, referenceValue);
    }
    verifiedRequirement.add(index, referenceValue);
    return verifiedRequirement.size() - 1;
  }

  public List<ReferenceValue> getVerifiedRequirement() {
    return verifiedRequirement;
  }

  public int addToVerifiedRequirement(RequirementUsage referred) {
    return addToVerifiedRequirement(new ReferenceValue(referred, null), verifiedRequirement.size());
  }

  public int addToVerifiedRequirement(RequirementUsage referred, int index) {
    return addToVerifiedRequirement(new ReferenceValue(referred, null), index);
  }

  public void clearVerifiedRequirement() {
    while (!verifiedRequirement.isEmpty()) {
            removeFromVerifiedRequirement(0);
        };
  }

  public void removeFromVerifiedRequirement(@NotNull ReferenceValue child) {
    int index = verifiedRequirement.indexOf(child);
             if (index == -1) {
                 throw new IllegalArgumentException("Child not found: " + child);
             }
             removeFromVerifiedRequirement(index);;
  }

  public void removeFromVerifiedRequirement(int index) {
    if (verifiedRequirement.size() > index) {

            ReferenceValue removed = verifiedRequirement.remove(index);
            if (partitionObserverCache != null) {
              partitionObserverCache.referenceValueRemoved(this, getClassifier().requireReferenceByName("verifiedRequirement"), index, removed);
            }
          } else {
            throw new IllegalArgumentException(
                "Invalid index "
                    ...
                    + verifiedRequirement.size());
          }
  }

  public void setVerifiedRequirement(@NotNull List<? extends ReferenceValue> newValue) {
    clearVerifiedRequirement();
          for (ReferenceValue referenceValue : newValue) {
              addToVerifiedRequirement(referenceValue, verifiedRequirement.size());
          }
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseUsage-verificationCaseDefinition")) {
      return Collections.singletonList(verificationCaseDefinition);
    }
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseUsage-verifiedRequirement")) {
      return verifiedRequirement;
    }
  ...
  public int addReferenceValue(Reference reference, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseUsage-verifiedRequirement")) {
      return addToVerifiedRequirement(referredNode, verifiedRequirement.size());
    }
    throw new IllegalStateException("Reference " + reference + " not found.");
  }
  ...
  public int addReferenceValue(Reference reference, int index, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseUsage-verifiedRequirement")) {
      return addToVerifiedRequirement(referredNode, index);
    }
    throw new IllegalStateException("Reference " + reference + " not found.");
  }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseUsage-verificationCaseDefinition")) {
      ...
      setVerificationCaseDefinition(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseUsage-verifiedRequirement")) {
      setVerifiedRequirement(values);
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseUsage-verificationCaseDefinition")) {
      if (index >= 1 || verificationCaseDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      verificationCaseDefinition = verificationCaseDefinition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseUsage-verifiedRequirement")) {
      if (index >= verifiedRequirement.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = verifiedRequirement.get(index);
      verifiedRequirement.set(index, original.withReferred(referredNode));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-objectiveRequirement")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseUsage-verificationCaseDefinition")) {
      if (index >= 1 || verificationCaseDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      verificationCaseDefinition = verificationCaseDefinition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-VerificationCaseUsage-verifiedRequirement")) {
      if (index >= verifiedRequirement.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = verifiedRequirement.get(index);
      verifiedRequirement.set(index, original.withResolveInfo(resolveInfo));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-CaseUsage-objectiveRequirement")) {
      if (index >= 1 || objectiveRequirement == null) throw new IllegalArgumentException("index should be less than the size of the list");;
