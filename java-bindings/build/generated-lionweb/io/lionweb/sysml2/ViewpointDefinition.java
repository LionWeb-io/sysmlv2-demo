...
public class ViewpointDefinition extends RequirementDefinition {
  @NotNull
  private String id;
  ...
  public ViewpointDefinition(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getViewpointDefinition();
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ViewpointDefinition-viewpointStakeholder")) {
      return viewpointStakeholder;
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-RequirementDefinition-subjectParameter")) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-RequirementDefinition-actorParameter")) {
      setActorParameter(values);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementDefinition-stakeholderParameter")) {
      setStakeholderParameter(values);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementDefinition-assumedConstraint")) {
      setAssumedConstraint(values);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementDefinition-requiredConstraint")) {
      setRequiredConstraint(values);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementDefinition-framedConcern")) {
