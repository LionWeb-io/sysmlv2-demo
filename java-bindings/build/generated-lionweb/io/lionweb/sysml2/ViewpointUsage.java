...
public class ViewpointUsage extends RequirementUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue viewpointDefinition = null;

  protected List<ReferenceValue> viewpointStakeholder = new ArrayList<>();

  public ViewpointUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getViewpointUsage();
  }

  public void setViewpointDefinition(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("viewpointDefinition"), 0, viewpointDefinition);
      }
      viewpointDefinition = null;
    } else {
      if (partitionObserverCache != null) {
        if (viewpointDefinition != null) {
          ReferenceValue oldValue = viewpointDefinition;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("viewpointDefinition"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("viewpointDefinition"), 0, value);
        }
      }
      this.viewpointDefinition = value;
    }
  }

  public ReferenceValue getViewpointDefinition() {
    return viewpointDefinition;
  }

  public int addToViewpointStakeholder(ReferenceValue referenceValue, int index) {
    if (index > viewpointStakeholder.size()) {
      throw new IllegalArgumentException("Index must be less than or equal to size");
    }
    if (partitionObserverCache != null) {
      partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("viewpointStakeholder"), index, referenceValue);
    }
    viewpointStakeholder.add(index, referenceValue);
    return viewpointStakeholder.size() - 1;
  }

  public List<ReferenceValue> getViewpointStakeholder() {
    return viewpointStakeholder;
  }

  public int addToViewpointStakeholder(IPartUsage referred) {
    return addToViewpointStakeholder(new ReferenceValue(referred, null), viewpointStakeholder.size());
  }

  public int addToViewpointStakeholder(IPartUsage referred, int index) {
    return addToViewpointStakeholder(new ReferenceValue(referred, null), index);
  }

  public void clearViewpointStakeholder() {
    while (!viewpointStakeholder.isEmpty()) {
            removeFromViewpointStakeholder(0);
        };
  }

  public void removeFromViewpointStakeholder(@NotNull ReferenceValue child) {
    int index = viewpointStakeholder.indexOf(child);
             if (index == -1) {
                 throw new IllegalArgumentException("Child not found: " + child);
             }
             removeFromViewpointStakeholder(index);;
  }

  public void removeFromViewpointStakeholder(int index) {
    if (viewpointStakeholder.size() > index) {

            ReferenceValue removed = viewpointStakeholder.remove(index);
            if (partitionObserverCache != null) {
              partitionObserverCache.referenceValueRemoved(this, getClassifier().requireReferenceByName("viewpointStakeholder"), index, removed);
            }
          } else {
            throw new IllegalArgumentException(
                "Invalid index "
                    ...
                    + viewpointStakeholder.size());
          }
  }

  public void setViewpointStakeholder(@NotNull List<? extends ReferenceValue> newValue) {
    clearViewpointStakeholder();
          for (ReferenceValue referenceValue : newValue) {
              addToViewpointStakeholder(referenceValue, viewpointStakeholder.size());
          }
  }
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-ViewpointUsage-viewpointDefinition")) {
      return Collections.singletonList(viewpointDefinition);
    }
    if (Objects.equals(reference.getKey(), "sysml-ViewpointUsage-viewpointStakeholder")) {
      return viewpointStakeholder;
    }
  ...
  public int addReferenceValue(Reference reference, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-ViewpointUsage-viewpointStakeholder")) {
      return addToViewpointStakeholder(referredNode, viewpointStakeholder.size());
    }
    throw new IllegalStateException("Reference " + reference + " not found.");
  }
  ...
  public int addReferenceValue(Reference reference, int index, ReferenceValue referredNode) {
    if (Objects.equals(reference.getKey(), "sysml-ViewpointUsage-viewpointStakeholder")) {
      return addToViewpointStakeholder(referredNode, index);
    }
    throw new IllegalStateException("Reference " + reference + " not found.");
  }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ViewpointUsage-viewpointDefinition")) {
      ...
      setViewpointDefinition(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ViewpointUsage-viewpointStakeholder")) {
      setViewpointStakeholder(values);
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-ViewpointUsage-viewpointDefinition")) {
      if (index >= 1 || viewpointDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      viewpointDefinition = viewpointDefinition.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ViewpointUsage-viewpointStakeholder")) {
      if (index >= viewpointStakeholder.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = viewpointStakeholder.get(index);
      viewpointStakeholder.set(index, original.withReferred(referredNode));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementUsage-requirementDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-ViewpointUsage-viewpointDefinition")) {
      if (index >= 1 || viewpointDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      viewpointDefinition = viewpointDefinition.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-ViewpointUsage-viewpointStakeholder")) {
      if (index >= viewpointStakeholder.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
      ReferenceValue original = viewpointStakeholder.get(index);
      viewpointStakeholder.set(index, original.withResolveInfo(resolveInfo));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-RequirementUsage-requirementDefinition")) {
      if (index >= 1 || requirementDefinition == null) throw new IllegalArgumentException("index should be less than the size of the list");;
