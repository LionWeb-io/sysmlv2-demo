...
public class WhileLoopActionUsage extends LoopActionUsage {
  @NotNull
  private String id;
  ...
  protected ReferenceValue whileArgument = null;

  protected ReferenceValue untilArgument = null;

  public WhileLoopActionUsage(@NotNull String id) {
    super(id);
  }
  ...
  public Concept getClassifier() {
    return SysmlLanguage.getInstance().getWhileLoopActionUsage();
  }

  public void setWhileArgument(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("whileArgument"), 0, whileArgument);
      }
      whileArgument = null;
    } else {
      if (partitionObserverCache != null) {
        if (whileArgument != null) {
          ReferenceValue oldValue = whileArgument;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("whileArgument"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("whileArgument"), 0, value);
        }
      }
      this.whileArgument = value;
    }
  }

  public ReferenceValue getWhileArgument() {
    return whileArgument;
  }

  public void setUntilArgument(ReferenceValue value) {
    if (value == null) {
      if (partitionObserverCache != null) {
        partitionObserverCache.referenceValueRemoved(this, this.getClassifier().requireReferenceByName("untilArgument"), 0, untilArgument);
      }
      untilArgument = null;
    } else {
      if (partitionObserverCache != null) {
        if (untilArgument != null) {
          ReferenceValue oldValue = untilArgument;
          partitionObserverCache.referenceValueChanged(this, this.getClassifier().requireReferenceByName("untilArgument"), 0, oldValue.getReferredID(), oldValue.getResolveInfo(), value.getReferredID(), value.getResolveInfo());
        } else {
          partitionObserverCache.referenceValueAdded(this, this.getClassifier().requireReferenceByName("untilArgument"), 0, value);
        }
      }
      this.untilArgument = value;
    }
  }

  public ReferenceValue getUntilArgument() {
  ...
  public List<ReferenceValue> getReferenceValues(@NotNull Reference reference) {
    ...
    if (Objects.equals(reference.getKey(), "sysml-WhileLoopActionUsage-whileArgument")) {
      return Collections.singletonList(whileArgument);
    }
    if (Objects.equals(reference.getKey(), "sysml-WhileLoopActionUsage-untilArgument")) {
      return Collections.singletonList(untilArgument);
    }
  ...
  public void setReferenceValues(@NotNull Reference reference,
    ...
    if (Objects.equals(reference.getKey(), "sysml-WhileLoopActionUsage-whileArgument")) {
      ...
      setWhileArgument(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-WhileLoopActionUsage-untilArgument")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setUntilArgument(values.isEmpty() ? null : values.get(0));
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-LoopActionUsage-bodyAction")) {
      if (values.size() > 0) throw new IllegalArgumentException("Cannot specifiy more than one value for a single-valued reference");
      setBodyAction(values.isEmpty() ? null : values.get(0));
      return;
    }
  ...
  public void setReferred(@NotNull Reference reference, int index, @Nullable Node referredNode) {
    ...
    if (index < 0) throw new IllegalArgumentException("index should be non-negative");;
    if (Objects.equals(reference.getKey(), "sysml-WhileLoopActionUsage-whileArgument")) {
      if (index >= 1 || whileArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      whileArgument = whileArgument.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-WhileLoopActionUsage-untilArgument")) {
      if (index >= 1 || untilArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      untilArgument = untilArgument.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-LoopActionUsage-bodyAction")) {
      if (index >= 1 || bodyAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      bodyAction = bodyAction.withReferred(referredNode);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
  ...
  public void setResolveInfo(@NotNull Reference reference, int index,
    ...
    if (Objects.equals(reference.getKey(), "sysml-WhileLoopActionUsage-whileArgument")) {
      if (index >= 1 || whileArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      whileArgument = whileArgument.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-WhileLoopActionUsage-untilArgument")) {
      if (index >= 1 || untilArgument == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      untilArgument = untilArgument.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-LoopActionUsage-bodyAction")) {
      if (index >= 1 || bodyAction == null) throw new IllegalArgumentException("index should be less than the size of the list");;
      bodyAction = bodyAction.withResolveInfo(resolveInfo);
      return;
    }
    if (Objects.equals(reference.getKey(), "sysml-IActionUsage-actionDefinition")) {
      if (index >= actionDefinition.size()) throw new IllegalArgumentException("index should be less than the size of the list");;
