...
[LionCoreMetaPointer(Language = typeof(SysmlLanguage), Key = "sysml-DecisionNode")]
public partial class DecisionNode : ControlNode
{
    ...
    /// <inheritdoc/>
    public override Concept GetConcept() => SysmlLanguage.Instance.DecisionNode;
}
