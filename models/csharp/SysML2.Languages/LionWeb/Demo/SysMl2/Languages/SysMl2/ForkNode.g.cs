...
[LionCoreMetaPointer(Language = typeof(SysmlLanguage), Key = "sysml-ForkNode")]
public partial class ForkNode : ControlNode
{
    ...
    /// <inheritdoc/>
    public override Concept GetConcept() => SysmlLanguage.Instance.ForkNode;
}
