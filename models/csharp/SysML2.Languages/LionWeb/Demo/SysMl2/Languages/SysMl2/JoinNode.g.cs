...
[LionCoreMetaPointer(Language = typeof(SysmlLanguage), Key = "sysml-JoinNode")]
public partial class JoinNode : ControlNode
{
    ...
    /// <inheritdoc/>
    public override Concept GetConcept() => SysmlLanguage.Instance.JoinNode;
}
