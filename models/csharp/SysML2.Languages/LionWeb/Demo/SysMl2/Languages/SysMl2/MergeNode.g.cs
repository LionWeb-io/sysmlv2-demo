...
[LionCoreMetaPointer(Language = typeof(SysmlLanguage), Key = "sysml-MergeNode")]
public partial class MergeNode : ControlNode
{
    ...
    /// <inheritdoc/>
    public override Concept GetConcept() => SysmlLanguage.Instance.MergeNode;
}
