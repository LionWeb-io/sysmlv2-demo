...
class InvocationExpression(DynamicNode):
    ...
    def add_to_argument(self, new_element: '"IExpression"'):
    ...
    @property
    def operand(self) ->'List["IExpression"]':
        res = self.get_children('operand')
        return res

    def add_to_operand(self, new_element: '"IExpression"'):
